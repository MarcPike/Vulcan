...
namespace DAL.Marketing.Core.Docs
{
    public class MarketingAccountFolder
    {
        ...
        public MarketingAccount GetMarketingAccount()
        {
            if (MarketingAccountId == ObjectId.Empty) return null;

            return new RepositoryBase<MarketingAccount>().Find(MarketingAccountId);
        }

        public MarketingAccountType? GetMarketingAccountType()
        {
