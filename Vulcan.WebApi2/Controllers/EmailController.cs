...
namespace Vulcan.WebApi2.Controllers
{
    ...
    {
        private readonly IHelperEmail _helperEmail;
        private readonly IHelperFile _helperFile;

        public EmailController(IHelperEmail helperEmail, IHelperFile helperFile, IHelperUser helperUser) : base(helperUser)
        {
            _helperEmail = helperEmail;
