...
//{
//    public class CrmQuoteHtmlGeneratorEur : CrmQuoteHtmlGenerator
//    {
//        public CrmQuoteHtmlGeneratorEur(CrmQuote quote, string contactName, string contactEmail, string contactPhone) : base(quote, contactName, contactEmail, contactPhone)
//        {
//        }
...
//        {
//            return new StringBuilder(PageHeaderEurope);
//        }

//        protected override StringBuilder GetNextPage()
//        {
//            return new StringBuilder(NextPageEurope);
//        }
...
//        protected override (string WeightSuffix, decimal Weight) GetWeightValues(List<CrmQuoteItem> quoteItems, List<CrmQuoteItem> quickQuoteItems, List<CrmQuoteItem> machinedParts)
//        {
//            var weightSuffix = " kg";
...
//                {
//                    thisItemHtml.Replace("[CurrencySymbolForTotal]", string.Empty);
//                    thisItemHtml.Replace("[ItemTotal]", "REGRET");
//                }
//                else
//                {
//                    thisItemHtml.Replace("[CurrencySymbolForTotal]", itemCurrencyValues.Symbol);
...
//                var quickQuoteQuantity = crmQuoteItem.QuickQuoteData.OrderQuantity.Quantity;
...
//                             crfqBegin [CUSTOMERRFQ] crfq end
//                           </td>
//                        </tr>
//                    </table>
//                </div>
...
//                            <td class='grid_top' style='font-size:13px; border-top:1px solid #ABB4C9; border-left:none; text-align: left; width:30%;'>
//                            <b>[ProductCode]</b>
//                            </td>
...
//                            <td class='grid_top' style='font-size:13px;  border-top:1px solid #ABB4C9; border-left:none;'>[CurrencySymbolForTotal][ItemTotal]</td>
