...
{
    public class CrmQuoteHtmlGeneratorMsa : CrmQuoteHtmlGenerator
    {
        public CrmQuoteHtmlGeneratorMsa(CrmQuote quote, string contactName, string contactEmail, string contactPhone) : base(quote, contactName, contactEmail, contactPhone)
        {
        }

        protected override string FormatDateForCoid(DateTime dateTime)
        {
            dateTime = DateTimeUtilities.OffsetDateTimeForCoid("MSA", dateTime);
        ...
        {
            return new StringBuilder(PageHeaderForMalaysia);
        }

        protected override StringBuilder GetPageFooter()
        {
            return new StringBuilder(PageFooterForMalaysia);
        }

        protected override StringBuilder GetNextPage()
        {
            return new StringBuilder(NextPageForMalaysia);
        }

        private string NextPageForMalaysia
        {
            get
            {
                        ...
                        <tr>
                           <td style='width:150px; padding:10px;'>
                            ...
                            <td style='font-size: 13px; padding: 5px 0 5px 5px;'>
                                <strong>Howco Metals Management Sdn Bhd</strong><br />
                                No 12, Jalan Laman Setia 7/5, Laman Setia,<br>
                                81550 Johor Bahru<br>
                                Johor Darul Takzim, Malaysia <br>
                                <strong>Tel:</strong> 607 509 5410<br />
                                <strong>Fax:</strong> 607 509 6192
                           </td>
        ...
        private string PageHeaderForMalaysia
        {
            get
            {
                var result = new StringBuilder();
        ...
        private string PageFooterForMalaysia
        {
            get
            {
                var result = new StringBuilder();
