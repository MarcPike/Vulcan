...
namespace Vulcan.IMetal.Context.PurchaseOrders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.PurchaseOrders.StockCast in the schema.
    /// </summary>
    ...
    public partial class StockCast : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<CountryCode> _CountryCode_CountryOfFinalProcessingId;

        private EntityRef<CountryCode> _CountryCode_CountryOfMaterialOriginId;

        private EntityRef<CountryCode> _CountryCode_CountryOfPrimaryProcessingId;
        ...
        public StockCast()
        {
            ...
            this._CountryCode_CountryOfFinalProcessingId  = default(EntityRef<CountryCode>);
            this._CountryCode_CountryOfMaterialOriginId  = default(EntityRef<CountryCode>);
            this._CountryCode_CountryOfPrimaryProcessingId  = default(EntityRef<CountryCode>);
            OnCreated();
        }
        ...
        public System.Nullable<int> CountryOfMaterialOriginId
        {
            ...
            set
            {
                ...
                {
                    if (this._CountryCode_CountryOfMaterialOriginId.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        public System.Nullable<int> CountryOfPrimaryProcessingId
        {
            ...
            set
            {
                ...
                {
                    if (this._CountryCode_CountryOfPrimaryProcessingId.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        public System.Nullable<int> CountryOfFinalProcessingId
        {
            ...
            set
            {
                ...
                {
                    if (this._CountryCode_CountryOfFinalProcessingId.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Company_StockCast", Storage="_Company", ThisKey="SupplierId", OtherKey="Id", IsForeignKey=true)]
        ...
        /// <summary>
        /// There are no comments for CountryCode_CountryOfFinalProcessingId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CountryCode_StockCast", Storage="_CountryCode_CountryOfFinalProcessingId", ThisKey="CountryOfFinalProcessingId", OtherKey="Id", IsForeignKey=true)]
        public CountryCode CountryCode_CountryOfFinalProcessingId
        {
            get
            {
                return this._CountryCode_CountryOfFinalProcessingId.Entity;
            }
            set
            {
                CountryCode previousValue = this._CountryCode_CountryOfFinalProcessingId.Entity;
                if ((previousValue != value) || (this._CountryCode_CountryOfFinalProcessingId.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("CountryCode_CountryOfFinalProcessingId");
                    if (previousValue != null)
                    {
                        this._CountryCode_CountryOfFinalProcessingId.Entity = null;
                        previousValue.StockCast_CountryOfFinalProcessingId.Remove(this);
                    }
                    this._CountryCode_CountryOfFinalProcessingId.Entity = value;
                    if (value != null)
                    {
                        this._CountryOfFinalProcessingId = value.Id;
                        value.StockCast_CountryOfFinalProcessingId.Add(this);
                    }
                    else
                    {
                        this._CountryOfFinalProcessingId = default(System.Nullable<int>);
                    }
                    this.SendPropertyChanged("CountryCode_CountryOfFinalProcessingId");
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for CountryCode_CountryOfMaterialOriginId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CountryCode_StockCast1", Storage="_CountryCode_CountryOfMaterialOriginId", ThisKey="CountryOfMaterialOriginId", OtherKey="Id", IsForeignKey=true)]
        public CountryCode CountryCode_CountryOfMaterialOriginId
        {
            get
            {
                return this._CountryCode_CountryOfMaterialOriginId.Entity;
            }
            set
            {
                CountryCode previousValue = this._CountryCode_CountryOfMaterialOriginId.Entity;
                if ((previousValue != value) || (this._CountryCode_CountryOfMaterialOriginId.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("CountryCode_CountryOfMaterialOriginId");
                    if (previousValue != null)
                    {
                        this._CountryCode_CountryOfMaterialOriginId.Entity = null;
                        previousValue.StockCast_CountryOfMaterialOriginId.Remove(this);
                    }
                    this._CountryCode_CountryOfMaterialOriginId.Entity = value;
                    if (value != null)
                    {
                        this._CountryOfMaterialOriginId = value.Id;
                        value.StockCast_CountryOfMaterialOriginId.Add(this);
                    }
                    else
                    {
                        this._CountryOfMaterialOriginId = default(System.Nullable<int>);
                    }
                    this.SendPropertyChanged("CountryCode_CountryOfMaterialOriginId");
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for CountryCode_CountryOfPrimaryProcessingId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CountryCode_StockCast2", Storage="_CountryCode_CountryOfPrimaryProcessingId", ThisKey="CountryOfPrimaryProcessingId", OtherKey="Id", IsForeignKey=true)]
        public CountryCode CountryCode_CountryOfPrimaryProcessingId
        {
            get
            {
                return this._CountryCode_CountryOfPrimaryProcessingId.Entity;
            }
            set
            {
                CountryCode previousValue = this._CountryCode_CountryOfPrimaryProcessingId.Entity;
                if ((previousValue != value) || (this._CountryCode_CountryOfPrimaryProcessingId.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("CountryCode_CountryOfPrimaryProcessingId");
                    if (previousValue != null)
                    {
                        this._CountryCode_CountryOfPrimaryProcessingId.Entity = null;
                        previousValue.StockCast_CountryOfPrimaryProcessingId.Remove(this);
                    }
                    this._CountryCode_CountryOfPrimaryProcessingId.Entity = value;
                    if (value != null)
                    {
                        this._CountryOfPrimaryProcessingId = value.Id;
                        value.StockCast_CountryOfPrimaryProcessingId.Add(this);
                    }
                    else
                    {
                        this._CountryOfPrimaryProcessingId = default(System.Nullable<int>);
                    }
                    this.SendPropertyChanged("CountryCode_CountryOfPrimaryProcessingId");
                }
            }
        }
