...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.CategoryGroup in the schema.
    /// </summary>
    [Table(Name = @"public.category_groups")]
    public partial class CategoryGroup : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CategoryGroup_Category", Storage="_Category", ThisKey="Id", OtherKey="CategoryGroupId", DeleteRule="NO ACTION")]
        ...
        private void attach_Category(Category entity)
        {
            ...
            entity.CategoryGroup = this;
        }
    
        private void detach_Category(Category entity)
        {
            this.SendPropertyChanging("Category");
            entity.CategoryGroup = null;
        }
    }
