...
namespace Vulcan.IMetal.Context.PurchaseOrders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.PurchaseOrders.Product in the schema.
    /// </summary>
    ...
    public partial class Product : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<PartNumberSpecification> _PartNumberSpecification_ConsumptionProductId;

        private EntitySet<PartNumberSpecification> _PartNumberSpecification_ProductId;
        ...
        public Product()
        {
            ...
            this._PartNumberSpecification_ConsumptionProductId = new EntitySet<PartNumberSpecification>(new Action<PartNumberSpecification>(this.attach_PartNumberSpecification_ConsumptionProductId), new Action<PartNumberSpecification>(this.detach_PartNumberSpecification_ConsumptionProductId));
            this._PartNumberSpecification_ProductId = new EntitySet<PartNumberSpecification>(new Action<PartNumberSpecification>(this.attach_PartNumberSpecification_ProductId), new Action<PartNumberSpecification>(this.detach_PartNumberSpecification_ProductId));
        ...
        /// <summary>
        /// There are no comments for PartNumberSpecification_ConsumptionProductId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Product_PartNumberSpecification", Storage="_PartNumberSpecification_ConsumptionProductId", ThisKey="Id", OtherKey="ConsumptionProductId", DeleteRule="NO ACTION")]
        public EntitySet<PartNumberSpecification> PartNumberSpecification_ConsumptionProductId
        {
            get
            {
                return this._PartNumberSpecification_ConsumptionProductId;
            }
            set
            {
                this._PartNumberSpecification_ConsumptionProductId.Assign(value);
            }
        }

    
        /// <summary>
        /// There are no comments for PartNumberSpecification_ProductId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Product_PartNumberSpecification1", Storage="_PartNumberSpecification_ProductId", ThisKey="Id", OtherKey="ProductId", DeleteRule="NO ACTION")]
        public EntitySet<PartNumberSpecification> PartNumberSpecification_ProductId
        {
            get
            {
                return this._PartNumberSpecification_ProductId;
            }
            set
            {
                this._PartNumberSpecification_ProductId.Assign(value);
            }
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Product_PurchaseOrderItem", Storage="_PurchaseOrderItem", ThisKey="Id", OtherKey="ProductId", DeleteRule="NO ACTION")]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Buyer_Product", Storage="_Buyer", ThisKey="BuyerId", OtherKey="Id", IsForeignKey=true)]
        public Buyer Buyer
        {
            get
            {
        ...
        private void attach_PartNumberSpecification_ConsumptionProductId(PartNumberSpecification entity)
        {
            this.SendPropertyChanging("PartNumberSpecification_ConsumptionProductId");
            entity.Product_ConsumptionProductId = this;
        }
    
        private void detach_PartNumberSpecification_ConsumptionProductId(PartNumberSpecification entity)
        {
            this.SendPropertyChanging("PartNumberSpecification_ConsumptionProductId");
            entity.Product_ConsumptionProductId = null;
        }

        private void attach_PartNumberSpecification_ProductId(PartNumberSpecification entity)
        {
            this.SendPropertyChanging("PartNumberSpecification_ProductId");
            entity.Product_ProductId = this;
        }
    
        private void detach_PartNumberSpecification_ProductId(PartNumberSpecification entity)
        {
            this.SendPropertyChanging("PartNumberSpecification_ProductId");
