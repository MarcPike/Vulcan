...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.CompanyTypeCode in the schema.
    /// </summary>
    [Table(Name = @"public.company_type_codes")]
    public partial class CompanyTypeCode : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CompanyTypeCode_Company", Storage="_Company", ThisKey="Id", OtherKey="TypeId", DeleteRule="NO ACTION")]
        ...
        private void attach_Company(Company entity)
        {
            ...
            entity.CompanyTypeCode = this;
        }
    
        private void detach_Company(Company entity)
        {
            this.SendPropertyChanging("Company");
            entity.CompanyTypeCode = null;
        }
    }
