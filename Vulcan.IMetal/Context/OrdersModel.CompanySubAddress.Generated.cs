...
namespace Vulcan.IMetal.Context.Orders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Orders.CompanySubAddress in the schema.
    /// </summary>
    ...
    public partial class CompanySubAddress : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public Branch Branch
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._Branch.HasLoadedOrAssignedValue == false))
                {
                    ...
                    {
                        this._ConsignmentBranchId = default(System.Nullable<int>);
                    }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CompanySubAddress_SalesHeader", Storage="_SalesHeader", ThisKey="Id", OtherKey="DeliverToId", DeleteRule="NO ACTION")]
