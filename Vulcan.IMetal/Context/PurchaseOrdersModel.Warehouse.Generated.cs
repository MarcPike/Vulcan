...
namespace Vulcan.IMetal.Context.PurchaseOrders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.PurchaseOrders.Warehouse in the schema.
    /// </summary>
    ...
    public partial class Warehouse : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Warehouse_PurchaseOrderHeader", Storage="_PurchaseOrderHeader", ThisKey="Id", OtherKey="DeliveryWarehouseId", DeleteRule="NO ACTION")]
