...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.SalesItem in the schema.
    /// </summary>
    ...
    public partial class SalesItem : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private int? _WeightUnitsId;

        private int? _PartCustomerId;

        private int? _PartSpecificationId;
        ...
        private int? _CreditedItem;

        private string _CreditReference;

        private int? _DespatchItemId;
        ...
        private int? _OriginalQuantityUnitId;

        private System.DateTime? _OriginalDueDate;

        private int? _TransportPiece;

        private decimal? _TransportQuantity;

        private decimal? _TransportWeight;
        ...
        private int? _InvoicedPiece;

        private decimal? _InvoicedQuantity;

        private decimal? _InvoicedWeight;

        private string _MarginType = @"M";

        private int? _BalanceTotalId;

        private int? _AllocatedPiece;

        private decimal? _AllocatedQuantity;

        private decimal? _AllocatedWeight;
        ...
        private int? _ProductLevelAllocationId;

        private decimal? _OutsideDiameter;

        private decimal? _OutsideDiameterMinimum;

        private decimal? _OutsideDiameterMaximum;

        private decimal? _PackHeight;

        private decimal? _PackHeightMinimum;

        private decimal? _PackHeightMaximum;

        private decimal? _PackWeight;

        private decimal? _PackWeightMinimum;

        private decimal? _PackWeightMaximum;

        private decimal? _InsideDiameter;

        private decimal? _InsideDiameterMinimum;

        private decimal? _InsideDiameterMaximum;

        private bool? _TrimRequired = false;

        private bool? _ShotblastingRequired = false;

        private string _PaintDescription;

        private int? _GroupPriceUnitId;

        private decimal? _GroupTotalPrice;

        private decimal? _GroupTotalValue;

        private int _AllocatedCoilPiece = 0;

        private int? _PackCountMinimum;

        private int? _PackCountMaximum;

        private decimal? _WorkOrderPrintedQuantity;

        private string _ProductDescription;

        private decimal _InvoiceCostingWeight = 0m;

        private int? _WorkingSpecificationId;

        private int? _CallOffPiece = 0;

        private decimal? _CallOffQuantity = 0m;

        private decimal? _CallOffWeight = 0m;

        private int? _BlanketItemId;

        private int? _CreditedOrderNumber;

        private int? _CreditedOrderItem;

        private int? _CreditedDespatchItem;

        private int? _PaintTypeId;

        private bool _StockAvailable = false;

        private decimal? _MixturePrice;

        private decimal? _FabricationPrice;

        private decimal? _AdjustmentPrice;

        private decimal? _YieldPercentage;

        private string _CreditedCustomerOrder;

        private bool? _CalculatePiece;

        private decimal? _StandardPrice;

        private string _CuttingGroupReference;

        private bool? _CompleteAfterNextInvoice = false;

        private decimal? _CompletionBalanceQuantity;

        private bool? _MechanicalCert = false;

        private bool? _ShowCountryOfMaterialOrigin = false;

        private bool? _ShowCountryOfPrimaryProcessing = false;

        private bool? _ShowCountryOfFinalProcessing = false;

        private bool? _ItemCredited = false;
        ...
        private decimal? _GroupCuttingCost;

        private int? _GroupCuttingCostUnitId;

        private decimal? _GroupDrillingCost;

        private int? _GroupDrillingCostUnitId;

        private decimal? _GroupPaintingCost;

        private int? _GroupPaintingCostUnitId;

        private decimal? _GroupShotblastingCost;

        private int? _GroupShotblastingCostUnitId;

        private int? _ProductSubGroupId;

        private decimal? _GroupConsumptionPrice;

        private int? _ImportBatchNumber;

        private int? _ImportNumber;

        private int? _ImportItem;
        ...
        private int? _OldestPurchaseOrderNumber;

        private string _IntercompanyPurchaseBranch;

        private int? _IntercompanyPurchaseOrder;

        private int? _IntercompanyPurchaseItem;

        private bool _FromFlatRolled = false;

        private string _OptimisationType;

        private bool _WorksOrderNotRequiredAfterProduction = false;

        private int? _FabricationProcessId;

        private int? _FabricationWorkCentreId;

        private int? _FabricationId;

        private int? _PriceBookId;

        private int? _PriceBookLevel;

        private int? _PriceBookQuantityBreak;

        private int? _InvoicedSalesItemId;

        private System.DateTime? _RequiredQuantityChangeTimestamp;

        private int? _SecantOptimiserResultId;

        private bool _MlcConversionAllowed = true;
        ...
        private EntitySet<SalesItem> _SalesItem_InvoicedSalesItemId1;

        private EntityRef<SalesItem> _SalesItem_InvoicedSalesItemId;
        ...
        partial void OnSalesHeaderIdChanging(int? value);
        ...
        partial void OnWeightUnitsIdChanging(int? value);
        partial void OnWeightUnitsIdChanged();
        partial void OnPartCustomerIdChanging(int? value);
        partial void OnPartCustomerIdChanged();
        partial void OnPartSpecificationIdChanging(int? value);
        ...
        partial void OnCreditedItemChanging(int? value);
        ...
        partial void OnDespatchItemIdChanging(int? value);
        ...
        partial void OnOriginalQuantityUnitIdChanging(int? value);
        partial void OnOriginalQuantityUnitIdChanged();
        partial void OnOriginalDueDateChanging(System.DateTime? value);
        partial void OnOriginalDueDateChanged();
        partial void OnTransportPieceChanging(int? value);
        partial void OnTransportPieceChanged();
        partial void OnTransportQuantityChanging(decimal? value);
        partial void OnTransportQuantityChanged();
        partial void OnTransportWeightChanging(decimal? value);
        ...
        partial void OnInvoicedPieceChanging(int? value);
        ...
        partial void OnInvoicedWeightChanging(decimal? value);
        ...
        partial void OnAllocatedPieceChanging(int? value);
        partial void OnAllocatedPieceChanged();
        partial void OnAllocatedQuantityChanging(decimal? value);
        partial void OnAllocatedQuantityChanged();
        partial void OnAllocatedWeightChanging(decimal? value);
        ...
        partial void OnProductLevelAllocationIdChanging(int? value);
        partial void OnProductLevelAllocationIdChanged();
        partial void OnOutsideDiameterChanging(decimal? value);
        partial void OnOutsideDiameterChanged();
        partial void OnOutsideDiameterMinimumChanging(decimal? value);
        partial void OnOutsideDiameterMinimumChanged();
        partial void OnOutsideDiameterMaximumChanging(decimal? value);
        partial void OnOutsideDiameterMaximumChanged();
        partial void OnPackHeightChanging(decimal? value);
        partial void OnPackHeightChanged();
        partial void OnPackHeightMinimumChanging(decimal? value);
        partial void OnPackHeightMinimumChanged();
        partial void OnPackHeightMaximumChanging(decimal? value);
        partial void OnPackHeightMaximumChanged();
        partial void OnPackWeightChanging(decimal? value);
        partial void OnPackWeightChanged();
        partial void OnPackWeightMinimumChanging(decimal? value);
        partial void OnPackWeightMinimumChanged();
        partial void OnPackWeightMaximumChanging(decimal? value);
        partial void OnPackWeightMaximumChanged();
        partial void OnInsideDiameterChanging(decimal? value);
        partial void OnInsideDiameterChanged();
        partial void OnInsideDiameterMinimumChanging(decimal? value);
        partial void OnInsideDiameterMinimumChanged();
        partial void OnInsideDiameterMaximumChanging(decimal? value);
        partial void OnInsideDiameterMaximumChanged();
        partial void OnTrimRequiredChanging(bool? value);
        partial void OnTrimRequiredChanged();
        partial void OnShotblastingRequiredChanging(bool? value);
        ...
        partial void OnGroupPriceUnitIdChanging(int? value);
        partial void OnGroupPriceUnitIdChanged();
        partial void OnGroupTotalPriceChanging(decimal? value);
        partial void OnGroupTotalPriceChanged();
        partial void OnGroupTotalValueChanging(decimal? value);
        ...
        partial void OnPackCountMinimumChanging(int? value);
        partial void OnPackCountMinimumChanged();
        partial void OnPackCountMaximumChanging(int? value);
        partial void OnPackCountMaximumChanged();
        partial void OnWorkOrderPrintedQuantityChanging(decimal? value);
        ...
        partial void OnWorkingSpecificationIdChanging(int? value);
        partial void OnWorkingSpecificationIdChanged();
        partial void OnCallOffPieceChanging(int? value);
        partial void OnCallOffPieceChanged();
        partial void OnCallOffQuantityChanging(decimal? value);
        partial void OnCallOffQuantityChanged();
        partial void OnCallOffWeightChanging(decimal? value);
        partial void OnCallOffWeightChanged();
        partial void OnBlanketItemIdChanging(int? value);
        partial void OnBlanketItemIdChanged();
        partial void OnCreditedOrderNumberChanging(int? value);
        partial void OnCreditedOrderNumberChanged();
        partial void OnCreditedOrderItemChanging(int? value);
        partial void OnCreditedOrderItemChanged();
        partial void OnCreditedDespatchItemChanging(int? value);
        partial void OnCreditedDespatchItemChanged();
        partial void OnPaintTypeIdChanging(int? value);
        partial void OnPaintTypeIdChanged();
        partial void OnStockAvailableChanging(bool value);
        partial void OnStockAvailableChanged();
        partial void OnMixturePriceChanging(decimal? value);
        partial void OnMixturePriceChanged();
        partial void OnFabricationPriceChanging(decimal? value);
        partial void OnFabricationPriceChanged();
        partial void OnAdjustmentPriceChanging(decimal? value);
        ...
        partial void OnCalculatePieceChanging(bool? value);
        ...
        partial void OnCompleteAfterNextInvoiceChanging(bool? value);
        partial void OnCompleteAfterNextInvoiceChanged();
        partial void OnCompletionBalanceQuantityChanging(decimal? value);
        ...
        partial void OnShowCountryOfMaterialOriginChanging(bool? value);
        partial void OnShowCountryOfMaterialOriginChanged();
        partial void OnShowCountryOfPrimaryProcessingChanging(bool? value);
        partial void OnShowCountryOfPrimaryProcessingChanged();
        partial void OnShowCountryOfFinalProcessingChanging(bool? value);
        partial void OnShowCountryOfFinalProcessingChanged();
        partial void OnItemCreditedChanging(bool? value);
        ...
        partial void OnGroupCuttingCostChanging(decimal? value);
        partial void OnGroupCuttingCostChanged();
        partial void OnGroupCuttingCostUnitIdChanging(int? value);
        partial void OnGroupCuttingCostUnitIdChanged();
        partial void OnGroupDrillingCostChanging(decimal? value);
        partial void OnGroupDrillingCostChanged();
        partial void OnGroupDrillingCostUnitIdChanging(int? value);
        partial void OnGroupDrillingCostUnitIdChanged();
        partial void OnGroupPaintingCostChanging(decimal? value);
        partial void OnGroupPaintingCostChanged();
        partial void OnGroupPaintingCostUnitIdChanging(int? value);
        partial void OnGroupPaintingCostUnitIdChanged();
        partial void OnGroupShotblastingCostChanging(decimal? value);
        partial void OnGroupShotblastingCostChanged();
        partial void OnGroupShotblastingCostUnitIdChanging(int? value);
        partial void OnGroupShotblastingCostUnitIdChanged();
        partial void OnProductSubGroupIdChanging(int? value);
        partial void OnProductSubGroupIdChanged();
        partial void OnGroupConsumptionPriceChanging(decimal? value);
        ...
        partial void OnImportItemChanging(int? value);
        ...
        partial void OnOldestPurchaseOrderNumberChanging(int? value);
        ...
        partial void OnIntercompanyPurchaseOrderChanging(int? value);
        partial void OnIntercompanyPurchaseOrderChanged();
        partial void OnIntercompanyPurchaseItemChanging(int? value);
        ...
        partial void OnOptimisationTypeChanging(string value);
        partial void OnOptimisationTypeChanged();
        partial void OnWorksOrderNotRequiredAfterProductionChanging(bool value);
        partial void OnWorksOrderNotRequiredAfterProductionChanged();
        partial void OnFabricationProcessIdChanging(int? value);
        partial void OnFabricationProcessIdChanged();
        partial void OnFabricationWorkCentreIdChanging(int? value);
        partial void OnFabricationWorkCentreIdChanged();
        partial void OnFabricationIdChanging(int? value);
        partial void OnFabricationIdChanged();
        partial void OnPriceBookIdChanging(int? value);
        partial void OnPriceBookIdChanged();
        partial void OnPriceBookLevelChanging(int? value);
        partial void OnPriceBookLevelChanged();
        partial void OnPriceBookQuantityBreakChanging(int? value);
        partial void OnPriceBookQuantityBreakChanged();
        partial void OnInvoicedSalesItemIdChanging(int? value);
        partial void OnInvoicedSalesItemIdChanged();
        partial void OnRequiredQuantityChangeTimestampChanging(System.DateTime? value);
        partial void OnRequiredQuantityChangeTimestampChanged();
        partial void OnSecantOptimiserResultIdChanging(int? value);
        partial void OnSecantOptimiserResultIdChanged();
        partial void OnMlcConversionAllowedChanging(bool value);
        partial void OnMlcConversionAllowedChanged();
        #endregion
        ...
        public SalesItem()
        {
            ...
            this._SalesItem_InvoicedSalesItemId1 = new EntitySet<SalesItem>(new Action<SalesItem>(this.attach_SalesItem_InvoicedSalesItemId1), new Action<SalesItem>(this.detach_SalesItem_InvoicedSalesItemId1));
            this._SalesItem_InvoicedSalesItemId  = default(EntityRef<SalesItem>);
            OnCreated();
        }
        ...
        public int? PartSpecificationId
        {
            get
            {
        ...
        public int? OriginalQuantityUnitId
        {
            get
            {
        ...
        public decimal? TransportQuantity
        {
            get
            {
        ...
        public decimal? TransportWeight
        {
            get
            {
        ...
        public decimal? AllocatedWeight
        {
            get
            {
        ...
        public int? ProductLevelAllocationId
        {
            get
            {
        ...
        public decimal? OutsideDiameterMinimum
        {
            get
            {
        ...
        public decimal? OutsideDiameterMaximum
        {
            get
            {
        ...
        public decimal? PackHeightMinimum
        {
            get
            {
        ...
        public decimal? PackHeightMaximum
        {
            get
            {
        ...
        public decimal? PackWeightMinimum
        {
            get
            {
        ...
        public decimal? PackWeightMaximum
        {
            get
            {
        ...
        public decimal? InsideDiameterMinimum
        {
            get
            {
        ...
        public decimal? InsideDiameterMaximum
        {
            get
            {
        ...
        public bool? ShotblastingRequired
        {
            get
            {
        ...
        public decimal? GroupTotalPrice
        {
            get
            {
        ...
        public decimal? GroupTotalValue
        {
            get
            {
        ...
        public decimal? WorkOrderPrintedQuantity
        {
            get
            {
        ...
        public int? WorkingSpecificationId
        {
            get
            {
        ...
        public decimal? CallOffQuantity
        {
            get
            {
        ...
        public int? CreditedOrderNumber
        {
            get
            {
        ...
        public int? CreditedDespatchItem
        {
            get
            {
        ...
        public decimal? FabricationPrice
        {
            get
            {
        ...
        public bool? CompleteAfterNextInvoice
        {
            get
            {
        ...
        public decimal? CompletionBalanceQuantity
        {
            get
            {
        ...
        public bool? ShowCountryOfMaterialOrigin
        {
            get
            {
        ...
        public bool? ShowCountryOfPrimaryProcessing
        {
            get
            {
        ...
        public bool? ShowCountryOfFinalProcessing
        {
            get
            {
        ...
        public decimal? GroupCuttingCost
        {
            get
            {
        ...
        public int? GroupCuttingCostUnitId
        {
            get
            {
        ...
        public decimal? GroupDrillingCost
        {
            get
            {
        ...
        public int? GroupDrillingCostUnitId
        {
            get
            {
        ...
        public decimal? GroupPaintingCost
        {
            get
            {
        ...
        public int? GroupPaintingCostUnitId
        {
            get
            {
        ...
        public decimal? GroupShotblastingCost
        {
            get
            {
        ...
        public int? GroupShotblastingCostUnitId
        {
            get
            {
        ...
        public decimal? GroupConsumptionPrice
        {
            get
            {
        ...
        public int? OldestPurchaseOrderNumber
        {
            get
            {
        ...
        public int? IntercompanyPurchaseOrder
        {
            get
            {
        ...
        public int? IntercompanyPurchaseItem
        {
            get
            {
        ...
        /// <summary>
        /// There are no comments for OptimisationType in the schema.
        /// </summary>
        [Column(Name = @"optimisation_type", Storage = "_OptimisationType", DbType = "VARCHAR(1)", UpdateCheck = UpdateCheck.Never)]
        public string OptimisationType
        {
            get
            {
                return this._OptimisationType;
            }
            set
            {
                if (this._OptimisationType != value)
                {
                    this.OnOptimisationTypeChanging(value);
                    this.SendPropertyChanging("OptimisationType");
                    this._OptimisationType = value;
                    this.SendPropertyChanged("OptimisationType");
                    this.OnOptimisationTypeChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for WorksOrderNotRequiredAfterProduction in the schema.
        /// </summary>
        [Column(Name = @"works_order_not_required_after_production", Storage = "_WorksOrderNotRequiredAfterProduction", CanBeNull = false, DbType = "BOOL NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public bool WorksOrderNotRequiredAfterProduction
        {
            get
            {
                return this._WorksOrderNotRequiredAfterProduction;
            }
            set
            {
                if (this._WorksOrderNotRequiredAfterProduction != value)
                {
                    this.OnWorksOrderNotRequiredAfterProductionChanging(value);
                    this.SendPropertyChanging("WorksOrderNotRequiredAfterProduction");
                    this._WorksOrderNotRequiredAfterProduction = value;
                    this.SendPropertyChanged("WorksOrderNotRequiredAfterProduction");
                    this.OnWorksOrderNotRequiredAfterProductionChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for FabricationProcessId in the schema.
        /// </summary>
        [Column(Name = @"fabrication_process_id", Storage = "_FabricationProcessId", DbType = "INT4", UpdateCheck = UpdateCheck.Never)]
        public int? FabricationProcessId
        {
            get
            {
                return this._FabricationProcessId;
            }
            set
            {
                if (this._FabricationProcessId != value)
                {
                    this.OnFabricationProcessIdChanging(value);
                    this.SendPropertyChanging("FabricationProcessId");
                    this._FabricationProcessId = value;
                    this.SendPropertyChanged("FabricationProcessId");
                    this.OnFabricationProcessIdChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for FabricationWorkCentreId in the schema.
        /// </summary>
        [Column(Name = @"fabrication_work_centre_id", Storage = "_FabricationWorkCentreId", DbType = "INT4", UpdateCheck = UpdateCheck.Never)]
        public int? FabricationWorkCentreId
        {
            get
            {
                return this._FabricationWorkCentreId;
            }
            set
            {
                if (this._FabricationWorkCentreId != value)
                {
                    this.OnFabricationWorkCentreIdChanging(value);
                    this.SendPropertyChanging("FabricationWorkCentreId");
                    this._FabricationWorkCentreId = value;
                    this.SendPropertyChanged("FabricationWorkCentreId");
                    this.OnFabricationWorkCentreIdChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for FabricationId in the schema.
        /// </summary>
        [Column(Name = @"fabrication_id", Storage = "_FabricationId", DbType = "INT4", UpdateCheck = UpdateCheck.Never)]
        public int? FabricationId
        {
            get
            {
                return this._FabricationId;
            }
            set
            {
                if (this._FabricationId != value)
                {
                    this.OnFabricationIdChanging(value);
                    this.SendPropertyChanging("FabricationId");
                    this._FabricationId = value;
                    this.SendPropertyChanged("FabricationId");
                    this.OnFabricationIdChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for PriceBookId in the schema.
        /// </summary>
        [Column(Name = @"price_book_id", Storage = "_PriceBookId", DbType = "INT4", UpdateCheck = UpdateCheck.Never)]
        public int? PriceBookId
        {
            ...
            set
            {
                if (this._PriceBookId != value)
                {
                    this.OnPriceBookIdChanging(value);
                    this.SendPropertyChanging("PriceBookId");
                    this._PriceBookId = value;
                    this.SendPropertyChanged("PriceBookId");
                    this.OnPriceBookIdChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for PriceBookLevel in the schema.
        /// </summary>
        [Column(Name = @"price_book_level", Storage = "_PriceBookLevel", DbType = "INT4", UpdateCheck = UpdateCheck.Never)]
        public int? PriceBookLevel
        {
            get
            {
                return this._PriceBookLevel;
            }
            set
            {
                if (this._PriceBookLevel != value)
                {
                    this.OnPriceBookLevelChanging(value);
                    this.SendPropertyChanging("PriceBookLevel");
                    this._PriceBookLevel = value;
                    this.SendPropertyChanged("PriceBookLevel");
                    this.OnPriceBookLevelChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for PriceBookQuantityBreak in the schema.
        /// </summary>
        [Column(Name = @"price_book_quantity_break", Storage = "_PriceBookQuantityBreak", DbType = "INT4", UpdateCheck = UpdateCheck.Never)]
        public int? PriceBookQuantityBreak
        {
            get
            {
                return this._PriceBookQuantityBreak;
            }
            set
            {
                if (this._PriceBookQuantityBreak != value)
                {
                    this.OnPriceBookQuantityBreakChanging(value);
                    this.SendPropertyChanging("PriceBookQuantityBreak");
                    this._PriceBookQuantityBreak = value;
                    this.SendPropertyChanged("PriceBookQuantityBreak");
                    this.OnPriceBookQuantityBreakChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for InvoicedSalesItemId in the schema.
        /// </summary>
        [Column(Name = @"invoiced_sales_item_id", Storage = "_InvoicedSalesItemId", DbType = "INT4", UpdateCheck = UpdateCheck.Never)]
        public int? InvoicedSalesItemId
        {
            get
            {
                return this._InvoicedSalesItemId;
            }
            set
            {
                if (this._InvoicedSalesItemId != value)
                {
                    if (this._SalesItem_InvoicedSalesItemId.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }

                    this.OnInvoicedSalesItemIdChanging(value);
                    this.SendPropertyChanging("InvoicedSalesItemId");
                    this._InvoicedSalesItemId = value;
                    this.SendPropertyChanged("InvoicedSalesItemId");
                    this.OnInvoicedSalesItemIdChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for RequiredQuantityChangeTimestamp in the schema.
        /// </summary>
        [Column(Name = @"required_quantity_change_timestamp", Storage = "_RequiredQuantityChangeTimestamp", DbType = "TIMESTAMPTZ", UpdateCheck = UpdateCheck.Never)]
        public System.DateTime? RequiredQuantityChangeTimestamp
        {
            get
            {
                return this._RequiredQuantityChangeTimestamp;
            }
            set
            {
                if (this._RequiredQuantityChangeTimestamp != value)
                {
                    this.OnRequiredQuantityChangeTimestampChanging(value);
                    this.SendPropertyChanging("RequiredQuantityChangeTimestamp");
                    this._RequiredQuantityChangeTimestamp = value;
                    this.SendPropertyChanged("RequiredQuantityChangeTimestamp");
                    this.OnRequiredQuantityChangeTimestampChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for SecantOptimiserResultId in the schema.
        /// </summary>
        [Column(Name = @"secant_optimiser_result_id", Storage = "_SecantOptimiserResultId", DbType = "INT4", UpdateCheck = UpdateCheck.Never)]
        public int? SecantOptimiserResultId
        {
            get
            {
                return this._SecantOptimiserResultId;
            }
            set
            {
                if (this._SecantOptimiserResultId != value)
                {
                    this.OnSecantOptimiserResultIdChanging(value);
                    this.SendPropertyChanging("SecantOptimiserResultId");
                    this._SecantOptimiserResultId = value;
                    this.SendPropertyChanged("SecantOptimiserResultId");
                    this.OnSecantOptimiserResultIdChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for MlcConversionAllowed in the schema.
        /// </summary>
        [Column(Name = @"mlc_conversion_allowed", Storage = "_MlcConversionAllowed", CanBeNull = false, DbType = "BOOL NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public bool MlcConversionAllowed
        {
            get
            {
                return this._MlcConversionAllowed;
            }
            set
            {
                if (this._MlcConversionAllowed != value)
                {
                    this.OnMlcConversionAllowedChanging(value);
                    this.SendPropertyChanging("MlcConversionAllowed");
                    this._MlcConversionAllowed = value;
                    this.SendPropertyChanged("MlcConversionAllowed");
                    this.OnMlcConversionAllowedChanged();
                }
            }
        }
        ...
        public SalesItem SalesItem_BlanketItemId
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._SalesItem_BlanketItemId.HasLoadedOrAssignedValue == false))
                {
                    ...
                    {
                        this._BlanketItemId = default(int?);
                    }
        ...
        public Company Company
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._Company.HasLoadedOrAssignedValue == false))
                {
                    ...
                    {
                        this._PartCustomerId = default(int?);
                    }
        ...
        public SalesHeader SalesHeader
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._SalesHeader.HasLoadedOrAssignedValue == false))
                {
                    ...
                    {
                        this._SalesHeaderId = default(int?);
                    }
        ...
        /// <summary>
        /// There are no comments for SalesItem_InvoicedSalesItemId1 in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SalesItem_SalesItem2", Storage="_SalesItem_InvoicedSalesItemId1", ThisKey="Id", OtherKey="InvoicedSalesItemId", DeleteRule="NO ACTION")]
        public EntitySet<SalesItem> SalesItem_InvoicedSalesItemId1
        {
            get
            {
                return this._SalesItem_InvoicedSalesItemId1;
            }
            set
            {
                this._SalesItem_InvoicedSalesItemId1.Assign(value);
            }
        }

    
        /// <summary>
        /// There are no comments for SalesItem_InvoicedSalesItemId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SalesItem_SalesItem2", Storage="_SalesItem_InvoicedSalesItemId", ThisKey="InvoicedSalesItemId", OtherKey="Id", IsForeignKey=true)]
        public SalesItem SalesItem_InvoicedSalesItemId
        {
            get
            {
                return this._SalesItem_InvoicedSalesItemId.Entity;
            }
            set
            {
                SalesItem previousValue = this._SalesItem_InvoicedSalesItemId.Entity;
                if ((previousValue != value) || (this._SalesItem_InvoicedSalesItemId.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("SalesItem_InvoicedSalesItemId");
                    if (previousValue != null)
                    {
                        this._SalesItem_InvoicedSalesItemId.Entity = null;
                        previousValue.SalesItem_InvoicedSalesItemId1.Remove(this);
                    }
                    this._SalesItem_InvoicedSalesItemId.Entity = value;
                    if (value != null)
                    {
                        this._InvoicedSalesItemId = value.Id;
                        value.SalesItem_InvoicedSalesItemId1.Add(this);
                    }
                    else
                    {
                        this._InvoicedSalesItemId = default(int?);
                    }
                    this.SendPropertyChanged("SalesItem_InvoicedSalesItemId");
                }
            }
        }
        ...
        private void attach_SalesItem_InvoicedSalesItemId1(SalesItem entity)
        {
            this.SendPropertyChanging("SalesItem_InvoicedSalesItemId1");
            entity.SalesItem_InvoicedSalesItemId = this;
        }
    
        private void detach_SalesItem_InvoicedSalesItemId1(SalesItem entity)
        {
            this.SendPropertyChanging("SalesItem_InvoicedSalesItemId1");
            entity.SalesItem_InvoicedSalesItemId = null;
        }
    }
