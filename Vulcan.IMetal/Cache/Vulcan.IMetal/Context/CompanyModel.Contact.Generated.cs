...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.Contact in the schema.
    /// </summary>
    ...
    public partial class Contact : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<ContactTypeCode> _ContactTypeCode;

        private EntityRef<ContactTitleCode> _ContactTitleCode;

        private EntityRef<Address> _Address;

        private EntityRef<Branch> _Branch;

        private EntityRef<ContactStatusCode> _ContactStatusCode;
        ...
        public Contact()
        {
            ...
            this._ContactTypeCode  = default(EntityRef<ContactTypeCode>);
            this._ContactTitleCode  = default(EntityRef<ContactTitleCode>);
            this._Address  = default(EntityRef<Address>);
            this._Branch  = default(EntityRef<Branch>);
            this._ContactStatusCode  = default(EntityRef<ContactStatusCode>);
        ...
        public int? TitleId
        {
            ...
            set
            {
                ...
                {
                    if (this._ContactTitleCode.HasLoadedOrAssignedValue)
                    {
        ...
        public int? TypeId
        {
            ...
            set
            {
                ...
                {
                    if (this._ContactTypeCode.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        public int? StatusId
        {
            ...
            set
            {
                ...
                {
                    if (this._ContactStatusCode.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ContactFrequencyCode_Contact", Storage="_ContactFrequencyCode", ThisKey="ContactFrequency", OtherKey="Id", IsForeignKey=true)]
        ...
        /// <summary>
        /// There are no comments for ContactTypeCode in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ContactTypeCode_Contact", Storage="_ContactTypeCode", ThisKey="TypeId", OtherKey="Id", IsForeignKey=true)]
        public ContactTypeCode ContactTypeCode
        {
            get
            {
                return this._ContactTypeCode.Entity;
            }
            set
            {
                ContactTypeCode previousValue = this._ContactTypeCode.Entity;
                if ((previousValue != value) || (this._ContactTypeCode.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("ContactTypeCode");
                    if (previousValue != null)
                    {
                        this._ContactTypeCode.Entity = null;
                        previousValue.Contact.Remove(this);
                    }
                    this._ContactTypeCode.Entity = value;
                    if (value != null)
                    {
                    ...
                    this.SendPropertyChanged("ContactTypeCode");
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for ContactTitleCode in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ContactTitleCode_Contact", Storage="_ContactTitleCode", ThisKey="TitleId", OtherKey="Id", IsForeignKey=true)]
        public ContactTitleCode ContactTitleCode
        {
            get
            {
                return this._ContactTitleCode.Entity;
            }
            set
            {
                ContactTitleCode previousValue = this._ContactTitleCode.Entity;
                if ((previousValue != value) || (this._ContactTitleCode.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("ContactTitleCode");
                    if (previousValue != null)
                    {
                        this._ContactTitleCode.Entity = null;
                        previousValue.Contact.Remove(this);
                    }
                    this._ContactTitleCode.Entity = value;
                    if (value != null)
                    {
                    ...
                    this.SendPropertyChanged("ContactTitleCode");
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for ContactStatusCode in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ContactStatusCode_Contact", Storage="_ContactStatusCode", ThisKey="StatusId", OtherKey="Id", IsForeignKey=true)]
        public ContactStatusCode ContactStatusCode
        {
            get
            {
                return this._ContactStatusCode.Entity;
            }
            set
            {
                ContactStatusCode previousValue = this._ContactStatusCode.Entity;
                if ((previousValue != value) || (this._ContactStatusCode.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("ContactStatusCode");
                    if (previousValue != null)
                    {
                        this._ContactStatusCode.Entity = null;
                        previousValue.Contact.Remove(this);
                    }
                    this._ContactStatusCode.Entity = value;
                    if (value != null)
                    {
                    ...
                    this.SendPropertyChanged("ContactStatusCode");
                }
            }
        }
