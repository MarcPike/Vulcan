...
namespace Vulcan.IMetal.Context.Orders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Orders.Product in the schema.
    /// </summary>
    ...
    public partial class Product : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<ProductSubGroup> _ProductSubGroup_ProductId;

        private EntitySet<ProductSubGroup> _ProductSubGroup_ProductionProductId;

        private EntitySet<SalesItem> _SalesItem;

        private EntitySet<TransportTypeCode> _TransportTypeCode;
        ...
        public Product()
        {
            ...
            this._ProductSubGroup_ProductId = new EntitySet<ProductSubGroup>(new Action<ProductSubGroup>(this.attach_ProductSubGroup_ProductId), new Action<ProductSubGroup>(this.detach_ProductSubGroup_ProductId));
            this._ProductSubGroup_ProductionProductId = new EntitySet<ProductSubGroup>(new Action<ProductSubGroup>(this.attach_ProductSubGroup_ProductionProductId), new Action<ProductSubGroup>(this.detach_ProductSubGroup_ProductionProductId));
            ...
            this._TransportTypeCode = new EntitySet<TransportTypeCode>(new Action<TransportTypeCode>(this.attach_TransportTypeCode), new Action<TransportTypeCode>(this.detach_TransportTypeCode));
            OnCreated();
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SalesGroup_Product", Storage="_SalesGroup", ThisKey="SalesGroupId", OtherKey="Id", IsForeignKey=true)]
        ...
        /// <summary>
        /// There are no comments for ProductSubGroup_ProductId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Product_ProductSubGroup", Storage="_ProductSubGroup_ProductId", ThisKey="Id", OtherKey="ProductId", DeleteRule="NO ACTION")]
        public EntitySet<ProductSubGroup> ProductSubGroup_ProductId
        {
            get
            {
                return this._ProductSubGroup_ProductId;
            }
            set
            {
                this._ProductSubGroup_ProductId.Assign(value);
            }
        }

    
        /// <summary>
        /// There are no comments for ProductSubGroup_ProductionProductId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Product_ProductSubGroup1", Storage="_ProductSubGroup_ProductionProductId", ThisKey="Id", OtherKey="ProductionProductId", DeleteRule="NO ACTION")]
        public EntitySet<ProductSubGroup> ProductSubGroup_ProductionProductId
        {
            get
            {
                return this._ProductSubGroup_ProductionProductId;
            }
            set
            {
                this._ProductSubGroup_ProductionProductId.Assign(value);
            }
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Product_SalesItem", Storage="_SalesItem", ThisKey="Id", OtherKey="ProductId", DeleteRule="NO ACTION")]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Product_TransportTypeCode", Storage="_TransportTypeCode", ThisKey="Id", OtherKey="SalesServiceProductId", DeleteRule="NO ACTION")]
        public EntitySet<TransportTypeCode> TransportTypeCode
        {
            get
            {
            ...
            set
            {
                this._TransportTypeCode.Assign(value);
            }
        }
        ...
        private void attach_ProductSubGroup_ProductId(ProductSubGroup entity)
        {
            this.SendPropertyChanging("ProductSubGroup_ProductId");
            entity.Product_ProductId = this;
        }
    
        private void detach_ProductSubGroup_ProductId(ProductSubGroup entity)
        {
            this.SendPropertyChanging("ProductSubGroup_ProductId");
            entity.Product_ProductId = null;
        }

        private void attach_ProductSubGroup_ProductionProductId(ProductSubGroup entity)
        {
            this.SendPropertyChanging("ProductSubGroup_ProductionProductId");
            entity.Product_ProductionProductId = this;
        }
    
        private void detach_ProductSubGroup_ProductionProductId(ProductSubGroup entity)
        {
            this.SendPropertyChanging("ProductSubGroup_ProductionProductId");
            entity.Product_ProductionProductId = null;
        }
        ...
        private void attach_TransportTypeCode(TransportTypeCode entity)
        {
            this.SendPropertyChanging("TransportTypeCode");
            entity.Product = this;
        }
    
        private void detach_TransportTypeCode(TransportTypeCode entity)
        {
            this.SendPropertyChanging("TransportTypeCode");
            entity.Product = null;
        }
