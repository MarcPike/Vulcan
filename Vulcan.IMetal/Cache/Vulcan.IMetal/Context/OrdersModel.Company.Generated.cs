...
namespace Vulcan.IMetal.Context.Orders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Orders.Company in the schema.
    /// </summary>
    ...
    public partial class Company : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<Personnel> _Personnel_PersonnelId;
        ...
        private EntitySet<ProductSubGroup> _ProductSubGroup_AlternateSupplierId;

        private EntitySet<ProductSubGroup> _ProductSubGroup_MainSupplierId;

        private EntitySet<SalesItem> _SalesItem;

        private EntitySet<CompanySubAddress> _CompanySubAddress;

        private EntitySet<SalesHeader> _SalesHeader_CarrierId;

        private EntitySet<SalesHeader> _SalesHeader_CustomerId;

        private EntitySet<Personnel> _Personnel_DefaultCustomerId;
        ...
        public Company()
        {
            ...
            this._Personnel_PersonnelId  = default(EntityRef<Personnel>);
            ...
            this._ProductSubGroup_AlternateSupplierId = new EntitySet<ProductSubGroup>(new Action<ProductSubGroup>(this.attach_ProductSubGroup_AlternateSupplierId), new Action<ProductSubGroup>(this.detach_ProductSubGroup_AlternateSupplierId));
            this._ProductSubGroup_MainSupplierId = new EntitySet<ProductSubGroup>(new Action<ProductSubGroup>(this.attach_ProductSubGroup_MainSupplierId), new Action<ProductSubGroup>(this.detach_ProductSubGroup_MainSupplierId));
            ...
            this._SalesHeader_CarrierId = new EntitySet<SalesHeader>(new Action<SalesHeader>(this.attach_SalesHeader_CarrierId), new Action<SalesHeader>(this.detach_SalesHeader_CarrierId));
            this._SalesHeader_CustomerId = new EntitySet<SalesHeader>(new Action<SalesHeader>(this.attach_SalesHeader_CustomerId), new Action<SalesHeader>(this.detach_SalesHeader_CustomerId));
            this._Personnel_DefaultCustomerId = new EntitySet<Personnel>(new Action<Personnel>(this.attach_Personnel_DefaultCustomerId), new Action<Personnel>(this.detach_Personnel_DefaultCustomerId));
        ...
        public System.Nullable<int> PersonnelId
        {
            ...
            set
            {
                ...
                {
                    if (this._Personnel_PersonnelId.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        public Contact Contact_DefaultContactId
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._Contact_DefaultContactId.HasLoadedOrAssignedValue == false))
                {
                    ...
                    {
                        this._DefaultContactId = default(System.Nullable<int>);
                    }
        ...
        /// <summary>
        /// There are no comments for Personnel_PersonnelId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Personnel_Company", Storage="_Personnel_PersonnelId", ThisKey="PersonnelId", OtherKey="Id", IsForeignKey=true)]
        public Personnel Personnel_PersonnelId
        {
            get
            {
                return this._Personnel_PersonnelId.Entity;
            }
            set
            {
                Personnel previousValue = this._Personnel_PersonnelId.Entity;
                if ((previousValue != value) || (this._Personnel_PersonnelId.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("Personnel_PersonnelId");
                    if (previousValue != null)
                    {
                        this._Personnel_PersonnelId.Entity = null;
                        previousValue.Company_PersonnelId.Remove(this);
                    }
                    this._Personnel_PersonnelId.Entity = value;
                    if (value != null)
                    {
                        this._PersonnelId = value.Id;
                        value.Company_PersonnelId.Add(this);
                    }
                    else
                    {
                        this._PersonnelId = default(System.Nullable<int>);
                    }
                    this.SendPropertyChanged("Personnel_PersonnelId");
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for ProductSubGroup_AlternateSupplierId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Company_ProductSubGroup", Storage="_ProductSubGroup_AlternateSupplierId", ThisKey="Id", OtherKey="AlternateSupplierId", DeleteRule="NO ACTION")]
        public EntitySet<ProductSubGroup> ProductSubGroup_AlternateSupplierId
        {
            get
            {
                return this._ProductSubGroup_AlternateSupplierId;
            }
            set
            {
                this._ProductSubGroup_AlternateSupplierId.Assign(value);
            }
        }

    
        /// <summary>
        /// There are no comments for ProductSubGroup_MainSupplierId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Company_ProductSubGroup1", Storage="_ProductSubGroup_MainSupplierId", ThisKey="Id", OtherKey="MainSupplierId", DeleteRule="NO ACTION")]
        public EntitySet<ProductSubGroup> ProductSubGroup_MainSupplierId
        {
            get
            {
                return this._ProductSubGroup_MainSupplierId;
            }
            set
            {
                this._ProductSubGroup_MainSupplierId.Assign(value);
            }
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Company_SalesItem", Storage="_SalesItem", ThisKey="Id", OtherKey="PartCustomerId", DeleteRule="NO ACTION")]
        ...
        /// <summary>
        /// There are no comments for SalesHeader_CarrierId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Company_SalesHeader", Storage="_SalesHeader_CarrierId", ThisKey="Id", OtherKey="CarrierId", DeleteRule="NO ACTION")]
        public EntitySet<SalesHeader> SalesHeader_CarrierId
        {
            get
            {
                return this._SalesHeader_CarrierId;
            }
            set
            {
                this._SalesHeader_CarrierId.Assign(value);
            }
        }

    
        /// <summary>
        /// There are no comments for SalesHeader_CustomerId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Company_SalesHeader1", Storage="_SalesHeader_CustomerId", ThisKey="Id", OtherKey="CustomerId", DeleteRule="NO ACTION")]
        public EntitySet<SalesHeader> SalesHeader_CustomerId
        {
            get
            {
                return this._SalesHeader_CustomerId;
            }
            set
            {
                this._SalesHeader_CustomerId.Assign(value);
            }
        }

    
        /// <summary>
        /// There are no comments for Personnel_DefaultCustomerId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Company_Personnel", Storage="_Personnel_DefaultCustomerId", ThisKey="Id", OtherKey="DefaultCustomerId", DeleteRule="NO ACTION")]
        public EntitySet<Personnel> Personnel_DefaultCustomerId
        {
            get
            {
                return this._Personnel_DefaultCustomerId;
            }
            set
            {
                this._Personnel_DefaultCustomerId.Assign(value);
            }
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Company_CostItem", Storage="_CostItem", ThisKey="Id", OtherKey="SupplierId", DeleteRule="NO ACTION")]
        ...
        private void attach_ProductSubGroup_AlternateSupplierId(ProductSubGroup entity)
        {
            this.SendPropertyChanging("ProductSubGroup_AlternateSupplierId");
            entity.Company_AlternateSupplierId = this;
        }
    
        private void detach_ProductSubGroup_AlternateSupplierId(ProductSubGroup entity)
        {
            this.SendPropertyChanging("ProductSubGroup_AlternateSupplierId");
            entity.Company_AlternateSupplierId = null;
        }

        private void attach_ProductSubGroup_MainSupplierId(ProductSubGroup entity)
        {
            this.SendPropertyChanging("ProductSubGroup_MainSupplierId");
            entity.Company_MainSupplierId = this;
        }
    
        private void detach_ProductSubGroup_MainSupplierId(ProductSubGroup entity)
        {
            this.SendPropertyChanging("ProductSubGroup_MainSupplierId");
            entity.Company_MainSupplierId = null;
        }
        ...
        private void attach_SalesHeader_CarrierId(SalesHeader entity)
        {
            this.SendPropertyChanging("SalesHeader_CarrierId");
            entity.Company_CarrierId = this;
        }
    
        private void detach_SalesHeader_CarrierId(SalesHeader entity)
        {
            this.SendPropertyChanging("SalesHeader_CarrierId");
            entity.Company_CarrierId = null;
        }

        private void attach_SalesHeader_CustomerId(SalesHeader entity)
        {
            this.SendPropertyChanging("SalesHeader_CustomerId");
            entity.Company_CustomerId = this;
        }
    
        private void detach_SalesHeader_CustomerId(SalesHeader entity)
        {
            this.SendPropertyChanging("SalesHeader_CustomerId");
            entity.Company_CustomerId = null;
        }

        private void attach_Personnel_DefaultCustomerId(Personnel entity)
        {
            this.SendPropertyChanging("Personnel_DefaultCustomerId");
            entity.Company_DefaultCustomerId = this;
        }
    
        private void detach_Personnel_DefaultCustomerId(Personnel entity)
        {
            this.SendPropertyChanging("Personnel_DefaultCustomerId");
            entity.Company_DefaultCustomerId = null;
        }
