...
namespace Vulcan.IMetal.Context.Orders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Orders.ProductClass in the schema.
    /// </summary>
    [Table(Name = @"public.product_classes")]
    public partial class ProductClass : INotifyPropertyChanging, INotifyPropertyChanged
    {
