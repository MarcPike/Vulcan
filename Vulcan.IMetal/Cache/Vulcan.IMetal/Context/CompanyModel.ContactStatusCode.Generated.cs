...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.ContactStatusCode in the schema.
    /// </summary>
    [Table(Name = @"public.contact_status_codes")]
    public partial class ContactStatusCode : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ContactStatusCode_Contact", Storage="_Contact", ThisKey="Id", OtherKey="StatusId", DeleteRule="NO ACTION")]
        ...
        private void attach_Contact(Contact entity)
        {
            ...
            entity.ContactStatusCode = this;
        }
    
        private void detach_Contact(Contact entity)
        {
            this.SendPropertyChanging("Contact");
            entity.ContactStatusCode = null;
        }
    }
