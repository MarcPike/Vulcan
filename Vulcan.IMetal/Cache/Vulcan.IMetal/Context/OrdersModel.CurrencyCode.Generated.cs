...
namespace Vulcan.IMetal.Context.Orders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Orders.CurrencyCode in the schema.
    /// </summary>
    ...
    public partial class CurrencyCode : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private System.Nullable<decimal> _InvoiceBaseCurrencyExchangeRate = 0m;

        private System.Nullable<System.DateTime> _DateLastSynchronised;
        ...
        partial void OnDateLastSynchronisedChanging(System.Nullable<System.DateTime> value);
        ...
        public System.Nullable<System.DateTime> DateLastSynchronised
        {
            get
            {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CurrencyCode_SalesHeader", Storage="_SalesHeader", ThisKey="Id", OtherKey="CurrencyId", DeleteRule="NO ACTION")]
