...
namespace Vulcan.IMetal.Context.Company
{
    ...
    public partial class Company : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private int? _FabricationPricingCategory;

        private int? _PriceBookLevel = 1;

        private bool _ContractJobRequired = false;
        ...
        private decimal? _MinimumCashSalePaymentPercentage;
        ...
        private EntitySet<CompanyCreditRule> _CompanyCreditRule_InsuranceCompanyId;

        private EntityRef<CompanyCreditRule> _CompanyCreditRule_CompanyCreditRulesId;
        ...
        partial void OnFabricationPricingCategoryChanging(int? value);
        partial void OnFabricationPricingCategoryChanged();
        partial void OnPriceBookLevelChanging(int? value);
        partial void OnPriceBookLevelChanged();
        partial void OnContractJobRequiredChanging(bool value);
        partial void OnContractJobRequiredChanged();
        ...
        partial void OnMinimumCashSalePaymentPercentageChanging(decimal? value);
        partial void OnMinimumCashSalePaymentPercentageChanged();
        partial void OnTransportCommentChanging(string value);
        partial void OnTransportCommentChanged();
        #endregion
        ...
        public Company()
        {
            ...
            this._CompanyCreditRule_InsuranceCompanyId = new EntitySet<CompanyCreditRule>(new Action<CompanyCreditRule>(this.attach_CompanyCreditRule_InsuranceCompanyId), new Action<CompanyCreditRule>(this.detach_CompanyCreditRule_InsuranceCompanyId));
            this._CompanyCreditRule_CompanyCreditRulesId  = default(EntityRef<CompanyCreditRule>);
        ...
        public int? CompanyCreditRulesId
        {
            ...
            set
            {
                ...
                {
                    if (this._CompanyCreditRule_CompanyCreditRulesId.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        /// <summary>
        /// There are no comments for FabricationPricingCategory in the schema.
        /// </summary>
        [Column(Name = @"fabrication_pricing_category", Storage = "_FabricationPricingCategory", DbType = "INT4", UpdateCheck = UpdateCheck.Never)]
        public int? FabricationPricingCategory
        {
            get
            {
                return this._FabricationPricingCategory;
            }
            set
            {
                if (this._FabricationPricingCategory != value)
                {
                    this.OnFabricationPricingCategoryChanging(value);
                    this.SendPropertyChanging("FabricationPricingCategory");
                    this._FabricationPricingCategory = value;
                    this.SendPropertyChanged("FabricationPricingCategory");
                    this.OnFabricationPricingCategoryChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for ContractJobRequired in the schema.
        /// </summary>
        [Column(Name = @"contract_job_required", Storage = "_ContractJobRequired", CanBeNull = false, DbType = "BOOL NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public bool ContractJobRequired
        {
            get
            {
                return this._ContractJobRequired;
            }
            set
            {
                if (this._ContractJobRequired != value)
                {
                    this.OnContractJobRequiredChanging(value);
                    this.SendPropertyChanging("ContractJobRequired");
                    this._ContractJobRequired = value;
                    this.SendPropertyChanged("ContractJobRequired");
                    this.OnContractJobRequiredChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for MinimumCashSalePaymentPercentage in the schema.
        /// </summary>
        [Column(Name = @"minimum_cash_sale_payment_percentage", Storage = "_MinimumCashSalePaymentPercentage", DbType = "NUMERIC(5,2)", UpdateCheck = UpdateCheck.Never)]
        public decimal? MinimumCashSalePaymentPercentage
        {
            get
            {
                return this._MinimumCashSalePaymentPercentage;
            }
            set
            {
                if (this._MinimumCashSalePaymentPercentage != value)
                {
                    this.OnMinimumCashSalePaymentPercentageChanging(value);
                    this.SendPropertyChanging("MinimumCashSalePaymentPercentage");
                    this._MinimumCashSalePaymentPercentage = value;
                    this.SendPropertyChanged("MinimumCashSalePaymentPercentage");
                    this.OnMinimumCashSalePaymentPercentageChanged();
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for TransportComment in the schema.
        /// </summary>
        [Column(Name = @"transport_comment", Storage = "_TransportComment", DbType = "VARCHAR(60)", UpdateCheck = UpdateCheck.Never)]
        public string TransportComment
        {
            get
            {
                return this._TransportComment;
            }
            set
            {
                if (this._TransportComment != value)
                {
                    this.OnTransportCommentChanging(value);
                    this.SendPropertyChanging("TransportComment");
                    this._TransportComment = value;
                    this.SendPropertyChanged("TransportComment");
                    this.OnTransportCommentChanged();
                }
            }
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="OrderClassification_Company", Storage="_OrderClassification", ThisKey="DefaultOrderClassificationId", OtherKey="Id", IsForeignKey=true)]
        public OrderClassification OrderClassification
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._OrderClassification.HasLoadedOrAssignedValue == false))
                {
                    ...
                    if (value != null)
                    {
                        this._DefaultOrderClassificationId = value.Id;
                        value.Company.Add(this);
                    }
                    else
                    {
                        this._DefaultOrderClassificationId = default(int?);
                    }
        ...
        /// <summary>
        /// There are no comments for CompanyCreditRule_InsuranceCompanyId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Company_CompanyCreditRule", Storage="_CompanyCreditRule_InsuranceCompanyId", ThisKey="Id", OtherKey="InsuranceCompanyId", DeleteRule="NO ACTION")]
        public EntitySet<CompanyCreditRule> CompanyCreditRule_InsuranceCompanyId
        {
            get
            {
                return this._CompanyCreditRule_InsuranceCompanyId;
            }
            set
            {
                this._CompanyCreditRule_InsuranceCompanyId.Assign(value);
            }
        }

    
        /// <summary>
        /// There are no comments for CompanyCreditRule_CompanyCreditRulesId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CompanyCreditRule_Company", Storage="_CompanyCreditRule_CompanyCreditRulesId", ThisKey="CompanyCreditRulesId", OtherKey="Id", IsForeignKey=true)]
        public CompanyCreditRule CompanyCreditRule_CompanyCreditRulesId
        {
            get
            {
                return this._CompanyCreditRule_CompanyCreditRulesId.Entity;
            }
            set
            {
                CompanyCreditRule previousValue = this._CompanyCreditRule_CompanyCreditRulesId.Entity;
                if ((previousValue != value) || (this._CompanyCreditRule_CompanyCreditRulesId.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("CompanyCreditRule_CompanyCreditRulesId");
                    if (previousValue != null)
                    {
                        this._CompanyCreditRule_CompanyCreditRulesId.Entity = null;
                        previousValue.Company_CompanyCreditRulesId.Remove(this);
                    }
                    this._CompanyCreditRule_CompanyCreditRulesId.Entity = value;
                    if (value != null)
                    {
                        this._CompanyCreditRulesId = value.Id;
                        value.Company_CompanyCreditRulesId.Add(this);
                    }
                    else
                    {
                        this._CompanyCreditRulesId = default(int?);
                    }
                    this.SendPropertyChanged("CompanyCreditRule_CompanyCreditRulesId");
                }
            }
        }
        ...
        private void attach_CompanyCreditRule_InsuranceCompanyId(CompanyCreditRule entity)
        {
            this.SendPropertyChanging("CompanyCreditRule_InsuranceCompanyId");
            entity.Company_InsuranceCompanyId = this;
        }
    
        private void detach_CompanyCreditRule_InsuranceCompanyId(CompanyCreditRule entity)
        {
            this.SendPropertyChanging("CompanyCreditRule_InsuranceCompanyId");
            entity.Company_InsuranceCompanyId = null;
        }
