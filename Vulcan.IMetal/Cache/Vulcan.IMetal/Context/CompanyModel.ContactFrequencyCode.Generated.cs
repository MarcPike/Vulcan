...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.ContactFrequencyCode in the schema.
    /// </summary>
    [Table(Name = @"public.contact_frequency_codes")]
    public partial class ContactFrequencyCode : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ContactFrequencyCode_Company", Storage="_Company", ThisKey="Id", OtherKey="ContactFrequency", DeleteRule="NO ACTION")]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ContactFrequencyCode_Contact", Storage="_Contact", ThisKey="Id", OtherKey="ContactFrequency", DeleteRule="NO ACTION")]
        ...
        private void attach_Company(Company entity)
        {
            ...
            entity.ContactFrequencyCode = this;
        }
    
        private void detach_Company(Company entity)
        {
            this.SendPropertyChanging("Company");
            entity.ContactFrequencyCode = null;
        }
