...
namespace Vulcan.IMetal.Context.Company
{
    ...
    public partial class CompanyContext : Devart.Data.Linq.DataContext
    {
        ...
        partial void InsertOrderClassification(OrderClassification instance);
        partial void UpdateOrderClassification(OrderClassification instance);
        partial void DeleteOrderClassification(OrderClassification instance);
        partial void InsertCompanyCreditRule(CompanyCreditRule instance);
        partial void UpdateCompanyCreditRule(CompanyCreditRule instance);
        partial void DeleteCompanyCreditRule(CompanyCreditRule instance);
        ...
        partial void InsertSalesGroupType(SalesGroupType instance);
        partial void UpdateSalesGroupType(SalesGroupType instance);
        partial void DeleteSalesGroupType(SalesGroupType instance);
        ...
        public Devart.Data.Linq.Table<OrderClassification> OrderClassification
        {
            get
            {
                return this.GetTable<OrderClassification>();
            }
        }

        public Devart.Data.Linq.Table<CompanyCreditRule> CompanyCreditRule
        {
            get
            {
                return this.GetTable<CompanyCreditRule>();
            }
        }
        ...
        public Devart.Data.Linq.Table<SalesGroupType> SalesGroupType
        {
            get
            {
                return this.GetTable<SalesGroupType>();
            }
        }
