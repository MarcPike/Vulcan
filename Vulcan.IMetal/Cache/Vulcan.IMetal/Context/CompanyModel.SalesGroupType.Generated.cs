...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.SalesGroupType in the schema.
    /// </summary>
    [Table(Name = @"public.sales_group_types")]
    public partial class SalesGroupType : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<SalesGroup> _SalesGroup;
        ...
        public SalesGroupType()
        {
            this._SalesGroup = new EntitySet<SalesGroup>(new Action<SalesGroup>(this.attach_SalesGroup), new Action<SalesGroup>(this.detach_SalesGroup));
            OnCreated();
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SalesGroupType_SalesGroup", Storage="_SalesGroup", ThisKey="Id", OtherKey="SalesGroupTypeId", DeleteRule="NO ACTION")]
        public EntitySet<SalesGroup> SalesGroup
        {
            get
            {
        ...
        private void attach_SalesGroup(SalesGroup entity)
        {
            this.SendPropertyChanging("SalesGroup");
            entity.SalesGroupType = this;
        }
    
        private void detach_SalesGroup(SalesGroup entity)
        {
            this.SendPropertyChanging("SalesGroup");
            entity.SalesGroupType = null;
        }
    }
