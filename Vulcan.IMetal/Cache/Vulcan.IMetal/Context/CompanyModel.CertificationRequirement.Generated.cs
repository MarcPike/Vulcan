...
namespace Vulcan.IMetal.Context.Company
{
    ...
    public partial class CertificationRequirement : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CertificationRequirement_SalesHeader", Storage="_SalesHeader", ThisKey="Id", OtherKey="CertificationsId", DeleteRule="NO ACTION")]
