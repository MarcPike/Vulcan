...
namespace Vulcan.IMetal.Context.Orders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Orders.EnquiryLostReason in the schema.
    /// </summary>
    [Table(Name = @"public.enquiry_lost_reasons")]
    public partial class EnquiryLostReason : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private System.Nullable<bool> _RequestValue = false;
        ...
        partial void OnRequestValueChanging(System.Nullable<bool> value);
        partial void OnRequestValueChanged();
        #endregion

        public EnquiryLostReason()
        {
        ...
        /// <summary>
        /// There are no comments for ValueDescription in the schema.
        /// </summary>
        [Column(Name = @"value_description", Storage = "_ValueDescription", DbType = "VARCHAR(255)", UpdateCheck = UpdateCheck.Never)]
        public string ValueDescription
        {
            ...
            set
            {
                if (this._ValueDescription != value)
                {
                    ...
                    this.SendPropertyChanging("ValueDescription");
        ...
        /// <summary>
        /// There are no comments for RequestValue in the schema.
        /// </summary>
        [Column(Name = @"request_value", Storage = "_RequestValue", DbType = "BOOL", UpdateCheck = UpdateCheck.Never)]
        public System.Nullable<bool> RequestValue
        {
            get
            {
            ...
            set
            {
                if (this._RequestValue != value)
                {
                    this.OnRequestValueChanging(value);
                    this.SendPropertyChanging("RequestValue");
                    this._RequestValue = value;
                    this.SendPropertyChanged("RequestValue");
                    this.OnRequestValueChanged();
                }
            }
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="EnquiryLostReason_SalesItem", Storage="_SalesItem", ThisKey="Id", OtherKey="LostReasonId", DeleteRule="NO ACTION")]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="EnquiryLostReason_SalesHeader", Storage="_SalesHeader", ThisKey="Id", OtherKey="LostReasonId", DeleteRule="NO ACTION")]
        ...
        private void attach_SalesItem(SalesItem entity)
        {
            ...
            entity.EnquiryLostReason = this;
        }
    
        private void detach_SalesItem(SalesItem entity)
        {
            this.SendPropertyChanging("SalesItem");
            entity.EnquiryLostReason = null;
        }
