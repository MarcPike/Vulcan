...
namespace Vulcan.IMetal.Context.Company
{
    ...
    public partial class CompanySubAddress : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private bool? _UseCompanyProductionRequirement = false;
        ...
        partial void OnUseCompanyProductionRequirementChanging(bool? value);
        partial void OnUseCompanyProductionRequirementChanged();
        ...
        /// <summary>
        /// There are no comments for UseCompanyProductionRequirement in the schema.
        /// </summary>
        [Column(Name = @"use_company_production_requirements", Storage = "_UseCompanyProductionRequirement", DbType = "BOOL", UpdateCheck = UpdateCheck.Never)]
        public bool? UseCompanyProductionRequirement
        {
            get
            {
                return this._UseCompanyProductionRequirement;
            }
            set
            {
                if (this._UseCompanyProductionRequirement != value)
                {
                    this.OnUseCompanyProductionRequirementChanging(value);
                    this.SendPropertyChanging("UseCompanyProductionRequirement");
                    this._UseCompanyProductionRequirement = value;
                    this.SendPropertyChanged("UseCompanyProductionRequirement");
                    this.OnUseCompanyProductionRequirementChanged();
                }
            }
        }
