...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.OrderClassification in the schema.
    /// </summary>
    [Table(Name = @"public.order_classifications")]
    public partial class OrderClassification : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="OrderClassification_Company", Storage="_Company", ThisKey="Id", OtherKey="DefaultOrderClassificationId", DeleteRule="NO ACTION")]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="OrderClassification_SalesHeader", Storage="_SalesHeader", ThisKey="Id", OtherKey="OrderClassificationId", DeleteRule="NO ACTION")]
        ...
        private void attach_Company(Company entity)
        {
            ...
            entity.OrderClassification = this;
        }
    
        private void detach_Company(Company entity)
        {
            this.SendPropertyChanging("Company");
            entity.OrderClassification = null;
        }
