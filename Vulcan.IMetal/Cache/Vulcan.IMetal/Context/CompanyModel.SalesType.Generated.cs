...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.SalesType in the schema.
    /// </summary>
    [Table(Name = @"public.sales_types")]
    public partial class SalesType : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SalesType_SalesHeader", Storage="_SalesHeader", ThisKey="Id", OtherKey="TypeId", DeleteRule="NO ACTION")]
