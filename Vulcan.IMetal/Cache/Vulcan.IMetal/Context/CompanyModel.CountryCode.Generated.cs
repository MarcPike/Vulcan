...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.CountryCode in the schema.
    /// </summary>
    ...
    public partial class CountryCode : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CountryCode_SalesHeader", Storage="_SalesHeader", ThisKey="Id", OtherKey="FinalDestinationId", DeleteRule="NO ACTION")]
