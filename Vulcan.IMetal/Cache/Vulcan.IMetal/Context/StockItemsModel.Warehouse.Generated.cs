...
namespace Vulcan.IMetal.Context.StockItems
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.StockItems.Warehouse in the schema.
    /// </summary>
    ...
    public partial class Warehouse : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Warehouse_StockItem", Storage="_StockItem", ThisKey="Id", OtherKey="WarehouseId", DeleteRule="NO ACTION")]
