...
namespace Vulcan.IMetal.Context.PurchaseOrders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.PurchaseOrders.CompanySubAddress in the schema.
    /// </summary>
    ...
    public partial class CompanySubAddress : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private System.Nullable<int> _ConsignmentBranchId;

        private System.Nullable<int> _ConsignmentWarehouseId;

        private System.Nullable<bool> _UseCompanyTax = true;
        ...
        private System.Nullable<bool> _CommercialTermsMandatory = false;

        private System.Nullable<int> _DefaultCommercialTermsId;
        ...
        private System.Nullable<bool> _DefaultAddress = false;
        ...
        private EntityRef<Warehouse> _Warehouse_ConsignmentWarehouseId;

        private EntitySet<Warehouse> _Warehouse_SubAddressId;
        ...
        partial void OnConsignmentBranchIdChanging(System.Nullable<int> value);
        partial void OnConsignmentBranchIdChanged();
        partial void OnConsignmentWarehouseIdChanging(System.Nullable<int> value);
        partial void OnConsignmentWarehouseIdChanged();
        partial void OnUseCompanyTaxChanging(System.Nullable<bool> value);
        ...
        partial void OnCommercialTermsMandatoryChanging(System.Nullable<bool> value);
        partial void OnCommercialTermsMandatoryChanged();
        partial void OnDefaultCommercialTermsIdChanging(System.Nullable<int> value);
        ...
        partial void OnDefaultAddressChanging(System.Nullable<bool> value);
        ...
        public CompanySubAddress()
        {
            ...
            this._Warehouse_ConsignmentWarehouseId  = default(EntityRef<Warehouse>);
            this._Warehouse_SubAddressId = new EntitySet<Warehouse>(new Action<Warehouse>(this.attach_Warehouse_SubAddressId), new Action<Warehouse>(this.detach_Warehouse_SubAddressId));
        ...
        public System.Nullable<int> ConsignmentBranchId
        {
            get
            {
        ...
        public System.Nullable<int> ConsignmentWarehouseId
        {
            get
            {
            ...
            set
            {
                ...
                {
                    if (this._Warehouse_ConsignmentWarehouseId.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        public System.Nullable<bool> UseCompanyTax
        {
            get
            {
        ...
        public System.Nullable<bool> CommercialTermsMandatory
        {
            get
            {
        ...
        public System.Nullable<int> DefaultCommercialTermsId
        {
            get
            {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CompanySubAddress_PurchaseOrderHeader", Storage="_PurchaseOrderHeader", ThisKey="Id", OtherKey="DeliverFromId", DeleteRule="NO ACTION")]
        ...
        /// <summary>
        /// There are no comments for Warehouse_ConsignmentWarehouseId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Warehouse_CompanySubAddress", Storage="_Warehouse_ConsignmentWarehouseId", ThisKey="ConsignmentWarehouseId", OtherKey="Id", IsForeignKey=true)]
        public Warehouse Warehouse_ConsignmentWarehouseId
        {
            get
            {
                return this._Warehouse_ConsignmentWarehouseId.Entity;
            }
            set
            {
                Warehouse previousValue = this._Warehouse_ConsignmentWarehouseId.Entity;
                if ((previousValue != value) || (this._Warehouse_ConsignmentWarehouseId.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("Warehouse_ConsignmentWarehouseId");
                    if (previousValue != null)
                    {
                        this._Warehouse_ConsignmentWarehouseId.Entity = null;
                        previousValue.CompanySubAddress_ConsignmentWarehouseId.Remove(this);
                    }
                    this._Warehouse_ConsignmentWarehouseId.Entity = value;
                    if (value != null)
                    {
                        this._ConsignmentWarehouseId = value.Id;
                        value.CompanySubAddress_ConsignmentWarehouseId.Add(this);
                    }
                    else
                    {
                        this._ConsignmentWarehouseId = default(System.Nullable<int>);
                    }
                    this.SendPropertyChanged("Warehouse_ConsignmentWarehouseId");
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for Warehouse_SubAddressId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CompanySubAddress_Warehouse", Storage="_Warehouse_SubAddressId", ThisKey="Id", OtherKey="SubAddressId", DeleteRule="NO ACTION")]
        public EntitySet<Warehouse> Warehouse_SubAddressId
        {
            get
            {
                return this._Warehouse_SubAddressId;
            }
            set
            {
                this._Warehouse_SubAddressId.Assign(value);
            }
        }
        ...
        private void attach_Warehouse_SubAddressId(Warehouse entity)
        {
            this.SendPropertyChanging("Warehouse_SubAddressId");
            entity.CompanySubAddress_SubAddressId = this;
        }
    
        private void detach_Warehouse_SubAddressId(Warehouse entity)
        {
            this.SendPropertyChanging("Warehouse_SubAddressId");
            entity.CompanySubAddress_SubAddressId = null;
        }
    }
