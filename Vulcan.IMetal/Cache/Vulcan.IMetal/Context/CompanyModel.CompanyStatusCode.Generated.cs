...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.CompanyStatusCode in the schema.
    /// </summary>
    [Table(Name = @"public.company_status_codes")]
    public partial class CompanyStatusCode : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CompanyStatusCode_Company", Storage="_Company", ThisKey="Id", OtherKey="StatusId", DeleteRule="NO ACTION")]
        ...
        private void attach_Company(Company entity)
        {
            ...
            entity.CompanyStatusCode = this;
        }
    
        private void detach_Company(Company entity)
        {
            this.SendPropertyChanging("Company");
            entity.CompanyStatusCode = null;
        }
    }
