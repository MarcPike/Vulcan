...
namespace Vulcan.IMetal.Context.Orders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Orders.ProductCategory in the schema.
    /// </summary>
    ...
    public partial class ProductCategory : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="SalesGroup_ProductCategory", Storage="_SalesGroup", ThisKey="SalesGroupId", OtherKey="Id", IsForeignKey=true)]
