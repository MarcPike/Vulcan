...
namespace Vulcan.IMetal.Context
{
    public static class ContextFactory
    {
        ...
        //    ";Licence Key=;";
        ...
        public static StockItemsContext GetStockItemsContextForCoid(string coid)
        {
            ...
            connectionString = CheckIfMssQcTesting(connectionString);

            //connectionString = connectionString + LicenseKey;
        ...
        private static string CheckIfMssQcTesting(string connectionString)
        {
            //if (IsMssQc) connectionString = connectionString.Replace("live_emetal", "mss_qc");
