...
namespace Vulcan.IMetal.Results
{
    ...
    public class CompanySearchResult
    {
        ...
        //public string DefaultFreightCode { get; set; }
        //public string DefaultFreightCodeDescription { get; set; }
        ...
        public CompanySearchResult(CompanyContext context, string coid, Company company, bool withAddresses)
        {
            ...
            OrderClassificationCode = company.OrderClassification?.Code ?? "<unspecified>";
            OrderClassificationDescription = company.OrderClassification?.Description ?? "<unspecified>";

            CountryCode = company.Address.CountryCode?.Code;
            CountryName = company.Address.CountryCode?.Description;
            CompanyStatusCode = company.CompanyStatusCode.Code;
            CompanyStatus = company.CompanyStatusCode.Status;
            CompanyStatusDescription = company.CompanyStatusCode.Description;

            //DefaultFreightCode = company.TransportTypeCode?.Code ?? string.Empty;
            //DefaultFreightCodeDescription = company.TransportTypeCode?.Description ?? string.Empty;
