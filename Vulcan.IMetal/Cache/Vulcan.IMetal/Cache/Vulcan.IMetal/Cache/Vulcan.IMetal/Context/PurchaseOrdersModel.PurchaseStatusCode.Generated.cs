...
namespace Vulcan.IMetal.Context.PurchaseOrders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.PurchaseOrders.PurchaseStatusCode in the schema.
    /// </summary>
    [Table(Name = @"public.purchase_status_codes")]
    public partial class PurchaseStatusCode : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="PurchaseStatusCode_PurchaseOrderHeader", Storage="_PurchaseOrderHeader", ThisKey="Id", OtherKey="StatusId", DeleteRule="NO ACTION")]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="PurchaseStatusCode_PurchaseOrderItem", Storage="_PurchaseOrderItem", ThisKey="Id", OtherKey="StatusId", DeleteRule="NO ACTION")]
