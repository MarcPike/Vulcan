...
namespace Vulcan.IMetal.Context.PurchaseOrders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.PurchaseOrders.PurchaseCategoryCode in the schema.
    /// </summary>
    [Table(Name = @"public.purchase_category_codes")]
    public partial class PurchaseCategoryCode : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="PurchaseCategoryCode_PurchaseOrderHeader", Storage="_PurchaseOrderHeader", ThisKey="Id", OtherKey="CategoryId", DeleteRule="NO ACTION")]
