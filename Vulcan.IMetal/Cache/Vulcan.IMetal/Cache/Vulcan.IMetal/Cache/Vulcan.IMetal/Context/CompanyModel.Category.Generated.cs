...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.Category in the schema.
    /// </summary>
    ...
    public partial class Category : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<CategoryGroup> _CategoryGroup;
        ...
        public Category()
        {
            this._CategoryGroup  = default(EntityRef<CategoryGroup>);
            OnCreated();
        }
        ...
        /// <summary>
        /// There are no comments for CategoryGroupId in the schema.
        /// </summary>
        [Column(Name = @"category_group_id", Storage = "_CategoryGroupId", DbType = "INT4", UpdateCheck = UpdateCheck.Never)]
        public int? CategoryGroupId
        {
            ...
            set
            {
                ...
                {
                    if (this._CategoryGroup.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }

                    this.OnCategoryGroupIdChanging(value);
                    this.SendPropertyChanging("CategoryGroupId");
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CategoryGroup_Category", Storage="_CategoryGroup", ThisKey="CategoryGroupId", OtherKey="Id", IsForeignKey=true)]
        public CategoryGroup CategoryGroup
        {
            get
            {
                return this._CategoryGroup.Entity;
            }
            set
            {
                CategoryGroup previousValue = this._CategoryGroup.Entity;
                if ((previousValue != value) || (this._CategoryGroup.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("CategoryGroup");
                    if (previousValue != null)
                    {
                        this._CategoryGroup.Entity = null;
                        previousValue.Category.Remove(this);
                    }
                    this._CategoryGroup.Entity = value;
                    if (value != null)
                    {
                        this._CategoryGroupId = value.Id;
                        value.Category.Add(this);
                    }
                    else
                    {
                        this._CategoryGroupId = default(int?);
                    }
                    this.SendPropertyChanged("CategoryGroup");
                }
            }
        }
