...
namespace Vulcan.IMetal.Context.PurchaseOrders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.PurchaseOrders.DimensionValue in the schema.
    /// </summary>
    ...
    public partial class DimensionValue : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<PartNumberSpecification> _PartNumberSpecification_ConsumptionDimensionsId;

        private EntitySet<PartNumberSpecification> _PartNumberSpecification_DimensionsId;
        ...
        {
            this._PartNumberSpecification_ConsumptionDimensionsId = new EntitySet<PartNumberSpecification>(new Action<PartNumberSpecification>(this.attach_PartNumberSpecification_ConsumptionDimensionsId), new Action<PartNumberSpecification>(this.detach_PartNumberSpecification_ConsumptionDimensionsId));
            this._PartNumberSpecification_DimensionsId = new EntitySet<PartNumberSpecification>(new Action<PartNumberSpecification>(this.attach_PartNumberSpecification_DimensionsId), new Action<PartNumberSpecification>(this.detach_PartNumberSpecification_DimensionsId));
        ...
        /// <summary>
        /// There are no comments for PartNumberSpecification_ConsumptionDimensionsId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="DimensionValue_PartNumberSpecification", Storage="_PartNumberSpecification_ConsumptionDimensionsId", ThisKey="Id", OtherKey="ConsumptionDimensionsId", DeleteRule="NO ACTION")]
        public EntitySet<PartNumberSpecification> PartNumberSpecification_ConsumptionDimensionsId
        {
            get
            {
                return this._PartNumberSpecification_ConsumptionDimensionsId;
            }
            set
            {
                this._PartNumberSpecification_ConsumptionDimensionsId.Assign(value);
            }
        }

    
        /// <summary>
        /// There are no comments for PartNumberSpecification_DimensionsId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="DimensionValue_PartNumberSpecification1", Storage="_PartNumberSpecification_DimensionsId", ThisKey="Id", OtherKey="DimensionsId", DeleteRule="NO ACTION")]
        public EntitySet<PartNumberSpecification> PartNumberSpecification_DimensionsId
        {
            get
            {
                return this._PartNumberSpecification_DimensionsId;
            }
            set
            {
                this._PartNumberSpecification_DimensionsId.Assign(value);
            }
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="DimensionValue_PurchaseOrderItem", Storage="_PurchaseOrderItem", ThisKey="Id", OtherKey="DimensionsId", DeleteRule="NO ACTION")]
        ...
        private void attach_PartNumberSpecification_ConsumptionDimensionsId(PartNumberSpecification entity)
        {
            this.SendPropertyChanging("PartNumberSpecification_ConsumptionDimensionsId");
            entity.DimensionValue_ConsumptionDimensionsId = this;
        }
    
        private void detach_PartNumberSpecification_ConsumptionDimensionsId(PartNumberSpecification entity)
        {
            this.SendPropertyChanging("PartNumberSpecification_ConsumptionDimensionsId");
            entity.DimensionValue_ConsumptionDimensionsId = null;
        }

        private void attach_PartNumberSpecification_DimensionsId(PartNumberSpecification entity)
        {
            this.SendPropertyChanging("PartNumberSpecification_DimensionsId");
            entity.DimensionValue_DimensionsId = this;
        }
    
        private void detach_PartNumberSpecification_DimensionsId(PartNumberSpecification entity)
        {
            this.SendPropertyChanging("PartNumberSpecification_DimensionsId");
            entity.DimensionValue_DimensionsId = null;
        }
