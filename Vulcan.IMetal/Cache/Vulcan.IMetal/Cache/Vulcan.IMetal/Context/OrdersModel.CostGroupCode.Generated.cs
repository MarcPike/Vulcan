...
namespace Vulcan.IMetal.Context.Orders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Orders.CostGroupCode in the schema.
    /// </summary>
    [Table(Name = @"public.cost_group_codes")]
    public partial class CostGroupCode : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"""sequence""", Storage = "_Sequence", CanBeNull = false, DbType = "INT2 NOT NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CostGroupCode_CostItem", Storage="_CostItem", ThisKey="Id", OtherKey="CostGroupId", DeleteRule="NO ACTION")]
        ...
        private void attach_CostItem(CostItem entity)
        {
            ...
            entity.CostGroupCode = this;
        }
    
        private void detach_CostItem(CostItem entity)
        {
            this.SendPropertyChanging("CostItem");
            entity.CostGroupCode = null;
        }
    }
