...
namespace Vulcan.IMetal.Context.PurchaseOrders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.PurchaseOrders.Mill in the schema.
    /// </summary>
    ...
    public partial class Mill : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="CountryCode_Mill", Storage="_CountryCode", ThisKey="DefaultCountryOfOriginId", OtherKey="Id", IsForeignKey=true)]
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._CountryCode.HasLoadedOrAssignedValue == false))
                {
                    ...
                    if (previousValue != null)
                    {
                        ...
                        previousValue.Mill.Remove(this);
                    }
                    this._CountryCode.Entity = value;
                    if (value != null)
                    {
                        this._DefaultCountryOfOriginId = value.Id;
                        value.Mill.Add(this);
                    }
                    else
                    {
                        this._DefaultCountryOfOriginId = default(System.Nullable<int>);
                    }
