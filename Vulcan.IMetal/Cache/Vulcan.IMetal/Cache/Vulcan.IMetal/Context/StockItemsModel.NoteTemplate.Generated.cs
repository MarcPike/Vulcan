...
namespace Vulcan.IMetal.Context.StockItems
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.StockItems.NoteTemplate in the schema.
    /// </summary>
    [Table(Name = @"public.note_templates")]
    public partial class NoteTemplate : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnNoteTypeIdChanging(System.Nullable<int> value);
