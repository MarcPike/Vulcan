...
namespace Vulcan.IMetal.Context.PurchaseOrders
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.PurchaseOrders.Buyer in the schema.
    /// </summary>
    [Table(Name = @"public.buyers")]
    public partial class Buyer : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"code", Storage = "_Code", DbType = "VARCHAR(4)", UpdateCheck = UpdateCheck.Never)]
        public string Code
        {
            get
            {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Buyer_Product", Storage="_Product", ThisKey="Id", OtherKey="BuyerId", DeleteRule="NO ACTION")]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Buyer_Company", Storage="_Company", ThisKey="Id", OtherKey="DefaultBuyerId", DeleteRule="NO ACTION")]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Buyer_PurchaseOrderHeader", Storage="_PurchaseOrderHeader", ThisKey="Id", OtherKey="BuyerId", DeleteRule="NO ACTION")]
