...
namespace Vulcan.IMetal.Context.Company
{
    ...
    /// <summary>
    /// There are no comments for Vulcan.IMetal.Context.Company.ContactTypeCode in the schema.
    /// </summary>
    [Table(Name = @"public.contact_type_codes")]
    public partial class ContactTypeCode : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ContactTypeCode_Contact", Storage="_Contact", ThisKey="Id", OtherKey="TypeId", DeleteRule="NO ACTION")]
        ...
        private void attach_Contact(Contact entity)
        {
            ...
            entity.ContactTypeCode = this;
        }
    
        private void detach_Contact(Contact entity)
        {
            this.SendPropertyChanging("Contact");
            entity.ContactTypeCode = null;
        }
    }
