...
namespace Vulcan.IMetal.Models
{
    public class ExchangeRate
    {
        ...
        public static List<ExchangeRate> GetRateListForCoid(string coid)
        {
            var result = new List<ExchangeRate>();

            if (coid == "INC") GetRatesForInc(result);
            if (coid == "EUR") GetRatesForEur(result);
            if (coid == "CAN") GetRatesForCan(result);
            if (coid == "SIN") GetRatesForSin(result);
            if (coid == "MSA") GetRatesForMsa(result);
            if (coid == "DUB") GetRatesForDub(result);
