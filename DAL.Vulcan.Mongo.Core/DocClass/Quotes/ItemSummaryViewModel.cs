...
namespace DAL.Vulcan.Mongo.Core.DocClass.Quotes
{
    public class ItemSummaryViewModel
    {
        ...
        public ItemSummaryViewModel(QuoteItemModel model)
        {
            ...
            {
                StartingProductCode = model.MachinedPartModel.StockItem.ProductCode;
                ProductCode = model.MachinedPartModel.ProductMaster.ProductCode;
                Inches = 0;
            ...
            else
            {
                ...
                Inches = model.QuotePriceModel?.MaterialCostValue.TotalInches ?? 0;
                ...
                Units = $"{model.QuotePriceModel?.MaterialCostValue.RequiredQuantity.PieceLength.Inches ?? 0} inch";
            }
        ...
        public ItemSummaryViewModel(CrmQuoteItem item)
        {
            ...
            {
                StartingProductCode = item.MachinedPartModel.StockItem.ProductCode;
                ProductCode = item.MachinedPartModel.ProductMaster.ProductCode;
                Inches = 0;
