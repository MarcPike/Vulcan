    ...
    public class ProductAnalysisResultModel
    {
        ...
        public void Calculate(List<ProductWinLossHistory> quotes)
        {
            ...
            Task getDays15 = new Task(() =>
            {
                Days15 = new AnalysisSummaryModel()
                {
                    Won = new AnalysisDetailModel(
                        quotes.Where(x => x.Win && x.WonLossDate >= days15).ToList(),
                        DisplayCurrency),
                    Lost = new AnalysisDetailModel(
                        quotes.Where(x => x.Loss && x.WonLossDate >= days15).ToList(),
                        DisplayCurrency),
                    Expired = new AnalysisDetailModel(
                        quotes.Where(x => x.Expired && x.ExpiredDate >= days15).ToList(),
                        DisplayCurrency),
                    Submitted = new AnalysisDetailModel(
                        quotes.Where(
                                x => x.Status == PipelineStatus.Submitted && x.SubmitDate >= days15)
                            .ToList(),
                        DisplayCurrency)
                };
            });
            ...
            Task getDays30 = new Task(() =>
            {
                ...
                {
                    Won = new AnalysisDetailModel(
                        quotes.Where(x => x.Win && x.WonLossDate >= days30).ToList(),
                        DisplayCurrency),
                    Lost = new AnalysisDetailModel(
                        quotes.Where(x => x.Loss && x.WonLossDate >= days30).ToList(),
                        DisplayCurrency),
                    Expired = new AnalysisDetailModel(
                        quotes.Where(x => x.Expired && x.ExpiredDate >= days30).ToList(),
                        DisplayCurrency),
                    Submitted = new AnalysisDetailModel(
                        quotes.Where(x =>
                            x.Status == PipelineStatus.Submitted && x.SubmitDate >= days30).ToList(),
                        DisplayCurrency)
                };
            });
            getDays30.Start();
            ...
            Task getDays60 = new Task(() =>
            {
                ...
                {
                    Won = new AnalysisDetailModel(
                        quotes.Where(x => x.Win && x.WonLossDate >= days60).ToList(),
                        DisplayCurrency),
                    Lost = new AnalysisDetailModel(
                        quotes.Where(x => x.Loss && x.WonLossDate >= days60).ToList(),
                        DisplayCurrency),
                    Expired = new AnalysisDetailModel(
                        quotes.Where(x => x.Expired && x.ExpiredDate >= days60).ToList(),
                        DisplayCurrency),
                    Submitted = new AnalysisDetailModel(
                        quotes.Where(x =>
                            x.Status == PipelineStatus.Submitted && x.SubmitDate >= days60).ToList(),
                        DisplayCurrency)
                };
            });
            getDays60.Start();
            ...
            Task getDays90 = new Task(() =>
            {
                ...
                {
                    Won = new AnalysisDetailModel(
                        quotes.Where(x => x.Win && x.WonLossDate >= days90).ToList(),
                        DisplayCurrency),
                    Lost = new AnalysisDetailModel(
                        quotes.Where(x => x.Loss && x.WonLossDate >= days90).ToList(),
                        DisplayCurrency),
                    Expired = new AnalysisDetailModel(
                        quotes.Where(x => x.Expired && x.ExpiredDate >= days90).ToList(),
                        DisplayCurrency),
                    Submitted = new AnalysisDetailModel(
                        quotes.Where(x =>
                            x.Status == PipelineStatus.Submitted && x.SubmitDate >= days90).ToList(),
                        DisplayCurrency)
                };
            });
            getDays90.Start();
            ...
            Task getDays120 = new Task(() =>
            {
                ...
                {
                    Won = new AnalysisDetailModel(
                        quotes.Where(x => x.Win && x.WonLossDate >= days120).ToList(),
                        DisplayCurrency),
                    Lost = new AnalysisDetailModel(
                        quotes.Where(x => x.Loss && x.WonLossDate >= days120).ToList(),
                        DisplayCurrency),
                    Expired = new AnalysisDetailModel(
                    ...
                    Submitted = new AnalysisDetailModel(
                        quotes.Where(x =>
                            x.Status == PipelineStatus.Submitted && x.SubmitDate >= days120).ToList(),
                        DisplayCurrency)
                };
            });
            getDays120.Start();
            ...
            Task getDaysOlderThan120 = new Task(() =>
            {
                ...
                {
                    Won = new AnalysisDetailModel(quotes.Where(x => x.Win).ToList(),
                        DisplayCurrency),
                    Lost = new AnalysisDetailModel(quotes.Where(x => x.Loss).ToList(),
                        DisplayCurrency),
                    Expired = new AnalysisDetailModel(
                        quotes.Where(x => x.Expired).ToList(),
                        DisplayCurrency),
                    Submitted = new AnalysisDetailModel(
                        quotes.Where(x => x.Status == PipelineStatus.Submitted).ToList(),
                        DisplayCurrency)
                };
            });
        ...
        public void OldCalculate(List<ProductWinLossHistory> quotes)
        {
            var days7 = DateTime.Now.AddDays(-7);
            var days15 = DateTime.Now.AddDays(-15);
            var days30 = DateTime.Now.AddDays(-30);
