...
namespace DAL.Vulcan.Mongo.Models
{
    public class CrozQuoteModel
    {
            ...
            string displayCurrency, string productCode)
        {
            ...
            if (companyId != null)
            {
                Company = DAL.Vulcan.Mongo.DocClass.Companies.Company.Helper.FindById(companyId)?.AsCompanyRef();
            }

            if (prospectId != null)
            {
                Prospect = DAL.Vulcan.Mongo.DocClass.Companies.Prospect.Helper.FindById(prospectId)?.AsProspectRef();
            }
