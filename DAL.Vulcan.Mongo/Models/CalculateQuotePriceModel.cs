...
namespace DAL.Vulcan.Mongo.Models
{
    ...
    public class CalculateQuotePriceModel 
    {
        ...
        public static Dictionary<int,string> GetQuoteCalcOverridesSupported()
        {
            var quoteCalcOverridesSupported = new Dictionary<int, string>();
            foreach (MaterialPriceOverrideType overrideType in Enum.GetValues(typeof(MaterialPriceOverrideType)))
            {
                quoteCalcOverridesSupported.Add((int)overrideType, overrideType.ToString());
            }
