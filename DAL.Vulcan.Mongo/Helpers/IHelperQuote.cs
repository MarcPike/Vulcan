...
namespace DAL.Vulcan.Mongo.Helpers
{
    public interface IHelperQuote
    {
        ...
        (CrmQuote SourceQuote, CrmQuote DestinationQuote) MoveQuoteItemToDifferentQuote(string application, string userId, string destinationQuoteId,
            string sourceQuoteItemId);

        (QuotePriceModel QuotePriceModel,CalculateQuotePriceModel CalculateQuotePriceModel) CalculateQuotePrice(CalculateQuotePriceModel model);

        QuotePipelineModel GetQuotesPipeline(string application, string userId, DateTime begDate, DateTime endDate, bool forTeam);
        ...
        (CalculateQuotePriceModel CalculateQuotePriceModel, QuotePriceModel QuotePriceModel)
            GetNewCalculateQuotePriceModelForPurchaseOrderItem(string coid, decimal costPerPound, int productId,
                OrderQuantity orderedQuantity, string application, string userId, string displayCurrency, string companyId);
        ...
        QuotePipelineModel GetQuotesPipelineForContact(string application, string userId, string contactId, string teamId);
