...
{
    public partial class SageVArpjd
    {
        ...
        public short Typedetl { get; set; }
        public string Iditem { get; set; }
        public string Iddist { get; set; }
        public string Itemdesc { get; set; }
        public decimal Qtyinvc { get; set; }
        public decimal Amtcosthc { get; set; }
        public decimal Amtcosttc { get; set; }
