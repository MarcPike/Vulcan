...
namespace DAL.Vulcan.Mongo.Base.Core.Logger
{
    public class VulcanLogger : IVulcanLogger
    {
        ...
        public void Log(VulcanLogLevel logLevel, string className, string methodName, string message, bool sendEmail = false, bool writeToEventLog = false, Dictionary<string,object> parameters = null)
        {
            ...
            if (writeToEventLog)
            {
                EventLog.WriteEntry($"Vulcan.Web.Service-Class:{className}=>Method:{methodName}", message);
            }
        ...
        public void Log(string className, string methodName, Exception exception, bool sendEmail = false, bool writeToEventLog = false, Dictionary<string, object> parameters = null)
        {
            ...
            Log(VulcanLogLevel.Error, className, methodName, message, sendEmail, writeToEventLog, parameters);
        }
    }
}